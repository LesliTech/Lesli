...
module Lesli
    class AssetHelperTest < LesliTesting::ViewTester
        ...
        test "returns application stylesheet by default for engine" do
            ...
            assert_equal("lesli/custom", lesli_stylesheet_path(nil, "custom"))
        end

        test "returns engine/stylesheet when engine is provided" do
            assert_equal("lesli/application", lesli_stylesheet_path(:lesli))
        end
        ...
        test "returns gem/application when gem and stylesheet are provided" do
            assert_equal("lesli_assets/application", lesli_stylesheet_path(:lesli_assets, "application"))
        end

        test "returns gem/custom when gem and stylesheet are provided" do
            assert_equal("lesli_assets/custom", lesli_stylesheet_path(:lesli_assets, "custom"))
        end
