    ...
    actions: {
        ...
        uploadFiles(files) {
            ...
            Promise.all(promises).then(() => {
                this.msg.success(this.translations.core.shared.messages_success_files_uploaded)
            }).catch(error => {
                console.log(error)
                this.msg.danger(this.translations.core.shared.messages_danger_file_uploaded)
            }).finally(() => {
                this.loading = false
            })
        },
        ...
        fetchFiles() {
            ...
            this.http.get(url).then(response => {
                ...
                console.log(error)
                this.msg.danger(this.translations.core.shared.messages_danger_getting_files)
            }).finally(() => {
                this.loading = false
            })
        },
        ...
        deleteFile(id) {
            ...
            this.http.delete(url).then(() => {
                ...
                this.fetchFiles()
                this.msg.success(this.translations.core.shared.messages_success_files_deleted)
            }).catch(error => {
                console.log(error)
                this.msg.danger(this.translations.core.shared.messages_danger_files_deleted)
            }).finally(() => {
                this.loading = false
                this.filesToUpload = []
            })
        ...
        fetchFileTypes() {
            ...
            this.http.get(url)
                .then(response => {
                    ...
                    console.log(error)
                    this.msg.danger(this.translations.core.shared.messages_danger_getting_file_types)
                }).finally(() => {
                    this.loading = false
                })
        },
