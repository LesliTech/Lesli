...
export const useCloudObjectAction = defineStore("cloud.object.action", {
    ...
    actions: {
        ...
        getActions(url){
            ...
            if (!url) url = this.url[this.cloudModule](`${this.cloudObject}/:id/actions`, this.cloudObjectId)
        ...
        putAction(action){
            ...
            this.http.put(url, data).then(result => {
                this.msg.success(I18n.t("core.messages_success_cloud_object_actions_updated"))
            }).catch(error => {
                this.msg.danger(I18n.t("core.shared.messages_danger_internal_error"))
            }).finally(()=>{
                this.loading = false
        ...
        deleteAction(group, deleted_action){
            ...
            this.http.delete(url).then(result => {
                ...
                this.actions_groups[group] = this.actions_groups[group].filter((action)=>{
