    ...
    actions: {
        ...
        */
        putAction(action){
            ...
            let cloudObjectSingular = this.singularize(this.cloudObject)
        ...
        */
        ...
        singularize(cloudObject) {
            if(cloudObject.match(/^[0-9]+$/)){
                return cloudObject
            }
            if(cloudObject.endsWith('ies')){
                return cloudObject.slice(0, -3).concat('y')
            }
            return cloudObject.slice(0, -1)
        },
        /**
