    ...
    actions: {
        ...
        postAnnouncement(){
            ...
            this.http.post(this.url.bell("announcements"), {
                announcement: {
                    ...this.announcement,
                    message: JSON.stringify(this.stripHtml(this.announcement.message))
                }
            }).then(() => {
        ...
        /**
         * @description This action is used to get only text when posting an announcement
         */
        stripHtml(html){
            var temporalDivElement = document.createElement("div")
            temporalDivElement.innerHTML = html // Get inner text from html string
