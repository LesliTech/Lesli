            ...
            this.http.get(url).then(result => {
                ...
                result.forEach((option)=>{
                    option.details.forEach((detail)=>{
                        this.association_details[detail.field_name] = []

                        detail.list.forEach((detail_option)=>{
                            this.association_details[detail.field_name].push({
                                label: detail_option.name,
                                value: detail_option.id
                            })
                        })
