...
function panelConnectStatus(record) {
    console.log(record)
    storeWorkflow.panelStatuses = true
    storeWorkflow.panelStatus = record
}
    ...
    <div class="block">
        ...
        <lesli-table 
            ...
            <template #options="{ record }">
                <a class="dropdown-item" @click="panelConnectStatus(record)">
                    Connect statuses
                </a>
