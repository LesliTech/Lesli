...
var LesliUrl = function (root="/") {
    ...
    // result: domain.com/user/1 
    // this is good to avoid string interpolation :)
    function __parsePath(path, params = {}) {
    ...
    var url = new String(root); // new String() is essential

    url.engine = function (engine, path, params) {
        return this.concat(engine).concat("/").concat(__parsePath(path, params));
    };
