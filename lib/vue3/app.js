...
export default (engine, routes=[]) => {
    ...
    router.afterEach((to, from) => {
        ...
        nextTick(() => {
            ...
            document.body.classList.add(to.matched[0].path.substring(1).replaceAll("/","-").replaceAll(":",""))
        })
    })
    ...
    app.component("lesli-data-empty", componentLesliEmpty)
    app.component("lesli-data-table", componentLesliTable)
    app.component("lesli-data-loading", componentLesliLoading)
    app.component("lesli-data-collapse", componentLesliCollapse)
