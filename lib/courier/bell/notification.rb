...
module Courier
    module Bell
        class Notification
            ...
            def self.new(user, subject, body:nil, url:nil, category:nil, user_receiver_id:nil, role_receiver_names:nil, user_receiver_emails:nil, type:nil, media:nil, payload:nil)
