...
// · Loading app layout
import componentApplicationEngine from "LesliVue/layout/application-engine.vue"
...
export default (module, apps, base_path, routes=[], data={}) => {
    ...
    data["ldonis"] = function() { console.log("ldonis works") }

    Vue.use(pluginStore, data)
    ...
    cloud_builder["components"] = { 
        "application-component-engine": componentApplicationEngine,
