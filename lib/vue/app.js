...
// · Loading app layout
// · ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~
import componentApplicationApps from 'LesliVue/layout/application-apps.vue'
...
import componentApplicationNavigation from 'LesliVue/layout/application-navigation.vue'
import componentApplicationNotification from 'LesliVue/layout/application-notification.vue'
import componentApplicationGlobalSearch from 'LesliVue/layout/application-global-search.vue'
...
export default (module, apps, base_path, routes=[]) => {
    ...
    cloud_builder['components'] = { 
        'application-component-apps': componentApplicationApps,
