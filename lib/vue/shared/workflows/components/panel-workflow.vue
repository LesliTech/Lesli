...
<template>
    <lesli-panel :open="storeWorkflow.panelNew">
        <template #header>
            New workflow
        </template>
        <template #default>
            <form class="p-5" @submit.prevent="storeWorkflow.postWorkflow()">
                <div class="field">
                    <label class="label">Name</label>
                    <div class="control">
                        <input class="input" type="text" v-model="storeWorkflow.workflow.name">
                    </div>
                </div>
