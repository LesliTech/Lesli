...
import componentApplicationBellAnnouncement from "Lesli/vue/layouts/application-announcements.vue"
...
export default (engine, routes=[]) => {
    ...
    appbuilder["components"] = { 
        ...
        "application-component-announcements": componentApplicationBellAnnouncement
        /*
