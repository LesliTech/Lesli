...
export default {
    install (Vue, options) {
        ...
        // @param date [Date] The data from which you want to extract the month name
        ...
        // @param date [Date] The date which you want to covert to a string format
        // @return [String] The string representation of the time of the date, including the time
        ...
        // @return Default configuration used by a vc-date-picker to set locale, first day of week, masks, etc.
