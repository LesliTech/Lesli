...
export default (module, base_path, apps, routes=[], data={}, custom_components = {}) => {
    ...
    // · Custom components to be used by each builder or engine. New keys will be ignored
    cloud_builder["components"] = Object.assign({}, cloud_builder["components"], custom_components)
