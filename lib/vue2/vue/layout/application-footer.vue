...
import componentDriverEvents from "LesliVue/components/chatbox/driver-events.vue"
...
export default {
    ...
    components: {
        'component-driver-events': componentDriverEvents
    },
    data() {
        return {
            timer: null,
...
<template>    
    <footer class="application-footer">
        <section class="application-commands" v-if="command_show">
