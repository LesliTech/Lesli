...
function getDatastore(firestore) {
    ...
    if (!datastoreInstances.has(firestore)) {
        ...
        const databaseInfo = makeDatabaseInfo(firestore._databaseId, firestore._persistenceKey, firestore._freezeSettings());
...
function registerFirestore() {
    _registerComponent(new Component('firestore/lite', container => {
        ...
        return ((app, auth) => new FirebaseFirestore(app, auth))(app, container.getProvider('auth-internal'));
    }, "PUBLIC" /* PUBLIC */));
