(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@firebase/app'), require('@firebase/component'), require('@firebase/logger'), require('util'), require('node-fetch'), require('crypto')) :
    typeof define === 'function' && define.amd ? define(['exports', 'tslib', '@firebase/app', '@firebase/component', '@firebase/logger', 'util', 'node-fetch', 'crypto'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.firebase = global.firebase || {}, global.firebase.firestore = {}), global.tslib, global.app, global.component, global.logger, global.util, global.nodeFetch, global.crypto));
}(this, (function (exports, tslib, app, component, logger, util, nodeFetch, crypto) { 'use strict';
    ...
    function logDebug(msg) {
        ...
        if (logClient.logLevel <= logger.LogLevel.DEBUG) {
            ...
            logClient.debug.apply(logClient, tslib.__spreadArrays(["Firestore (" + version$1 + "): " + msg], args));
        }
    }
    function logError(msg) {
        ...
        if (logClient.logLevel <= logger.LogLevel.ERROR) {
            var args = obj.map(argToString);
            logClient.error.apply(logClient, tslib.__spreadArrays(["Firestore (" + version$1 + "): " + msg], args));
        }
    }
    function logWarn(msg) {
        ...
        if (logClient.logLevel <= logger.LogLevel.WARN) {
            var args = obj.map(argToString);
            logClient.warn.apply(logClient, tslib.__spreadArrays(["Firestore (" + version$1 + "): " + msg], args));
        }
    }
    /**
    ...
    function getDatastore(firestore) {
        ...
        if (!datastoreInstances.has(firestore)) {
            ...
            var databaseInfo = makeDatabaseInfo(firestore._databaseId, firestore._persistenceKey, firestore._freezeSettings());
    ...
    function registerFirestore() {
        app._registerComponent(new component.Component('firestore/lite', function (container) {
            ...
            return (function (app, auth) { return new FirebaseFirestore(app, auth); })(app, container.getProvider('auth-internal'));
        }, "PUBLIC" /* PUBLIC */));
    ...
    function getDoc(reference) {
        ...
        return invokeBatchGetDocumentsRpc(datastore, [reference._key]).then(function (result) {
            ...
            return new DocumentSnapshot(reference.firestore, userDataWriter, reference._key, maybeDocument instanceof Document ? maybeDocument : null, reference._converter);
        });
    }
    /**
