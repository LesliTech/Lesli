 ...
 * limitations under the License.
 */
const c = new i("@firebase/firestore");
...
function h(t, ...n) {
    if (c.logLevel <= o.DEBUG) {
        const e = n.map(d);
        c.debug(`Firestore (8.2.7): ${t}`, ...e);
    }
}

function l(t, ...n) {
    if (c.logLevel <= o.ERROR) {
        const e = n.map(d);
        c.error(`Firestore (8.2.7): ${t}`, ...e);
    }
}

function f(t, ...n) {
    if (c.logLevel <= o.WARN) {
        const e = n.map(d);
        c.warn(`Firestore (8.2.7): ${t}`, ...e);
    }
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const p = "ok", y = "cancelled", E = "unknown", I = "invalid-argument", T = "deadline-exceeded", A = "not-found", P = "already-exists", R = "permission-denied", V = "unauthenticated", g = "resource-exhausted", v = "failed-precondition", b = "aborted", N = "out-of-range", $ = "unimplemented", D = "internal", F = "unavailable", S = "data-loss";
...
function rt(t) {
    ...
    // https://github.com/googleapis/googleapis/blob/master/google/rpc/code.proto
      ...
      default:
        return t >= 200 && t < 300 ? p : t >= 400 && t < 500 ? v : t >= 500 && t < 600 ? D : E;
    }
}
...
function qn(t, n) {
    return "found" in n ? function(t, n) {
        ...
        const e = Dn(t, n.found.name), s = bn(n.found.updateTime), r = new xt({
            mapValue: {
        ...
        const e = Dn(t, n.missing), s = bn(n.readTime);
        return new Lt(e, s);
    }(t, n) : _();
}
...
async function Kn(t, n) {
    ...
    return (await e.ht("RunQuery", s.parent, {
        ...
        const s = Dn(t, n.name), r = bn(n.updateTime), i = new xt({
            mapValue: {
                fields: n.fields
            }
        });
 ...
 * terminated.
 */ function re(t) {
    return t = J(t, te), n(t.app, "firestore/lite"), t._delete();
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ e(new r("firestore/lite", (t => ((t, n) => new te(t, n))(t.getProvider("app-exp").getImmediate(), t.getProvider("auth-internal"))), "PUBLIC" /* PUBLIC */)), 
s("firestore-lite", "2.1.6", "node");

export { _e as Bytes, ce as CollectionReference, oe as DocumentReference, We as DocumentSnapshot, we as FieldPath, pe as FieldValue, te as FirebaseFirestore, x as FirestoreError, ye as GeoPoint, ue as Query, Ke as QueryConstraint, ze as QueryDocumentSnapshot, Ge as QuerySnapshot, lt as Timestamp, qs as Transaction, bs as WriteBatch, As as addDoc, gs as arrayRemove, Vs as arrayUnion, ae as collection, he as collectionGroup, Ts as deleteDoc, Ps as deleteField, le as doc, me as documentId, hs as endAt, as as endBefore, ps as getDoc, ys as getDocs, ee as getFirestore, vs as increment, ne as initializeFirestore, ss as limit, rs as limitToLast, ns as orderBy, Je as query, de as queryEqual, fe as refEqual, Os as runTransaction, Rs as serverTimestamp, Es as setDoc, a as setLogLevel, Ye as snapshotEqual, us as startAfter, os as startAt, re as terminate, Is as updateDoc, se as useFirestoreEmulator, Xe as where, $s as writeBatch };
