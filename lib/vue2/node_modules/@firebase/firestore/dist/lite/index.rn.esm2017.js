 ...
 */ function w(t = "Unexpected state") {
    ...
    const n = "FIRESTORE (8.2.7) INTERNAL ASSERTION FAILED: " + t;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const y = "ok", E = "cancelled", I = "unknown", T = "invalid-argument", A = "deadline-exceeded", P = "not-found", R = "already-exists", V = "permission-denied", g = "unauthenticated", v = "resource-exhausted", b = "failed-precondition", N = "aborted", $ = "out-of-range", D = "unimplemented", F = "internal", S = "unavailable", x = "data-loss";
 ...
 */ class G {
    ...
    isEqual(t) {
        return null !== t && 0 === Q.D(this.path, t.path);
    }
    toString() {
        return this.path.toString();
    }
    static D(t, n) {
        return Q.D(t.path, n.path);
    }
    static tt(t) {
        return t.length % 2 == 0;
    }
...
function it(t) {
    ...
    // https://github.com/googleapis/googleapis/blob/master/google/rpc/code.proto
      ...
      default:
        return t >= 200 && t < 300 ? y : t >= 400 && t < 500 ? b : t >= 500 && t < 600 ? F : I;
    }
}
...
function Nt(t, n) {
    ...
    switch (e) {
      ...
      case 3 /* TimestampValue */ :
        return $t(t.timestampValue, n.timestampValue);
 ...
 */ class Ut extends Lt {
    ...
    isEqual(t) {
        return t instanceof Ut && this.key.isEqual(t.key) && this.version.isEqual(t.version) && this.Dt === t.Dt && this.hasCommittedMutations === t.hasCommittedMutations && this.$t.isEqual(t.$t);
    }
    toString() {
...
/** A Filter that implements the array-contains operator. */ class Yt extends kt {
    ...
    matches(t) {
        const n = t.field(this.field);
        return Ft(n) && bt(n.arrayValue, this.value);
    }
}
...
/** A Filter that implements the array-contains-any operator. */ class Jt extends kt {
    ...
    matches(t) {
        const n = t.field(this.field);
        return !(!Ft(n) || !n.arrayValue.values) && n.arrayValue.values.some((t => bt(this.value.arrayValue, t)));
    }
}
...
function Cn(t, n) {
    return "found" in n ? function(t, n) {
        ...
        const e = Sn(t, n.found.name), s = $n(n.found.updateTime), r = new Ot({
            mapValue: {
        ...
        const e = Sn(t, n.missing), s = $n(n.readTime);
        return new jt(e, s);
    }(t, n) : w();
}
...
async function Zn(t, n) {
    ...
    return (await e.ht("RunQuery", s.parent, {
        ...
        const s = Sn(t, n.name), r = $n(n.updateTime), i = new Ot({
            mapValue: {
                fields: n.fields
            }
        });
 ...
 */ (t, n), null;
    ...
    return function(t, n) {
        ...
        if (t instanceof ce) {
            ...
            return {
                referenceValue: Dn(t.firestore.Tn || n.g, t.xn.path)
            };
        }
...
/** Helper function to create a bound from a document or fields */ function ds(t, n, e, s) {
    if (e[0] instanceof ue && (e[0] = e[0].et), e[0] instanceof Ge) return function(t, n, e, s, r) {
        ...
        // results.
                for (const e of cn(t)) if (e.field.Y()) i.push(Dt(n, s.key)); else {
...
function _s(t, n, e) {
    ...
    if (e instanceof ce) return Dt(t, e.xn);
 ...
 */ function Is(t) {
    !function(t) {
        if (sn(t) && 0 === t.Ct.length) throw new q(D, "limitToLast() queries require specifying at least one orderBy() clause");
    }((t = Z(t, ae)).On);
 ...
 */ class $s {
    ...
    set(t, n, e) {
        this.Ne();
        const s = Ds(t, this.se), r = ps(s.Sn, n, e), i = be(this.be, "WriteBatch.set", s.xn, r, null !== s.Sn, e);
        return this.ge.push(i.Mn(s.xn, yn.Qt())), this;
    }
    update(t, n, e, ...s) {
        this.Ne();
        const r = Ds(t, this.se);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let i;
 ...
 */ class Ss {
    ...
    async commit() {
        ...
        })), await Kn(this.$e, this.mutations), this.Fe = !0;
    }
    Ce(t) {
        let n;
...
class xs {
    constructor(t, n, e, s) {
        this.Yt = t, this.$e = n, this.updateFunction = e, this.Zt = s, this.Ue = 5, this.je = new Yn(this.Yt, "transaction_retry" /* TransactionRetry */);
    }
    ...
    Me() {
        this.je.dn((async () => {
            const t = new Ss(this.$e), n = this.Be(t);
            n && n.then((n => {
...
class Cs {
     ...
     */    get(t) {
        const n = Ds(t, this.se), e = new ys(this.se);
    ...
    set(t, n, e) {
        const s = Ds(t, this.se), r = ps(s.Sn, n, e), i = be(this.be, "Transaction.set", s.xn, r, null !== s.Sn, e);
