...
declare type NullableMaybeDocumentMap = SortedMap<DocumentKey, MaybeDocument | null>;
...
declare interface RemoteDocumentCache {
     ...
     */
    getDocumentsMatchingQuery(transaction: PersistenceTransaction, query: Query_2, sinceReadTime: SnapshotVersion): PersistencePromise<DocumentMap>;
    /**
