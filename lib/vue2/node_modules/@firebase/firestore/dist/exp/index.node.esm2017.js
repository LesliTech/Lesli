...
function initializeFirestore(app, settings) {
    const firestore = _getProvider(app, 'firestore-exp').getImmediate();
    if (settings.cacheSizeBytes !== undefined &&
...
function registerFirestore() {
    _registerComponent(new Component('firestore-exp', container => {
        const app = container.getProvider('app-exp').getImmediate();
        return ((app, auth) => new FirebaseFirestore$1(app, auth))(app, container.getProvider('auth-internal'));
    }, "PUBLIC" /* PUBLIC */));
