...
import { getUA as c, isMobileCordova as a, isReactNative as u, isElectron as h, isIE as l, isUWP as _, isBrowserExtension as f } from "@firebase/util";

import { XhrIo as d, EventType as w, ErrorCode as E, createWebChannelTransport as T, getStatEventTarget as I, WebChannel as m, Event as A, Stat as R } from "@firebase/webchannel-wrapper";
...
P.o = new P("google-credentials-uid"), P.u = new P("first-party-uid");
 ...
 * limitations under the License.
 */
const V = new r("@firebase/firestore");
...
/** A CredentialsProvider that always yields an empty token. */ class k {
    constructor() {
        /**
...
class M {
    constructor(t) {
        ...
        this.currentUser = P.UNAUTHENTICATED, this.A = !1, 
        /**
    ...
    getToken() {
        ...
        this.getToken()) : e ? (C("string" == typeof e.accessToken), new O(e.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
    }
    _() {
        this.forceRefresh = !0;
    }
    ...
    P() {
        ...
        return C(null === t || "string" == typeof t), new P(t);
    }
}
 ...
 */ class F {
    constructor(t, e) {
        this.V = t, this.g = e, this.type = "FirstParty", this.user = P.u;
    }
    get h() {
        const t = {
 ...
 */ class L {
    ...
    getToken() {
        return Promise.resolve(new F(this.V, this.g));
    }
    T(t) {
...
class z {
     ...
     */
    constructor(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new $(x.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new $(x.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new $(x.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new $(x.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
 ...
 */ class Y extends J {
     ...
     */    static nt(...t) {
        ...
        const e = [];
        for (const n of t) {
            if (n.indexOf("//") >= 0) throw new $(x.INVALID_ARGUMENT, `Invalid segment (${n}). Paths must not contain // in them.`);
...
/** A dot-separated path for navigating sub-objects within a document. */ class Z extends J {
    ...
    et() {
        return this.tt().map((t => (t = t.replace(/\\/g, "\\\\").replace(/`/g, "\\`"), Z.it(t) || (t = "`" + t + "`"), 
        t))).join(".");
    }
    toString() {
        return this.et();
     ...
     */    static ct(t) {
        ...
        let n = "", s = 0;
        const i = () => {
            if (0 === n.length) throw new $(x.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
            e.push(n), n = "";
        };
        let r = !1;
        for (;s < t.length; ) {
            const e = t[s];
            if ("\\" === e) {
                if (s + 1 === t.length) throw new $(x.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                const e = t[s + 1];
                if ("\\" !== e && "." !== e && "`" !== e) throw new $(x.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                n += e, s += 2;
            } else "`" === e ? (r = !r, s++) : "." !== e || r ? (n += e, s++) : (i(), s++);
        }
        if (i(), r) throw new $(x.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new Z(e);
    }
    static st() {
        return new Z([]);
 ...
 */ class tt {
    ...
    static at(t) {
        return new tt(Y.nt(t));
    }
    static ut(t) {
        return new tt(Y.nt(t).j(5));
    }
    /** Returns true if the document is in the specified collectionId. */    ht(t) {
        return this.path.length >= 2 && this.path.get(this.path.length - 2) === t;
    }
    isEqual(t) {
        return null !== t && 0 === Y.K(this.path, t.path);
    }
    toString() {
        return this.path.toString();
    }
    static K(t, e) {
        return Y.K(t.path, e.path);
    }
    static lt(t) {
        return t.length % 2 == 0;
    }
...
/** Extracts the backend's type order for the provided value. */ function Et(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? ht(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : D();
}
    ...
    switch (n) {
      ...
      case 7 /* RefValue */ :
        return function(t, e) {
            ...
            return W(n.length, s.length);
        }(t.referenceValue, e.referenceValue);

      case 8 /* GeoPointValue */ :
        return function(t, e) {
            const n = W(at(t.latitude), at(e.latitude));
            if (0 !== n) return n;
            return W(at(t.longitude), at(e.longitude));
...
function At(t, e) {
    ...
    const n = ct(t), s = ct(e), i = W(n.seconds, s.seconds);
    return 0 !== i ? i : W(n.nanos, s.nanos);
}
 ...
 */ function _e(t) {
    ...
    if (null === e.Nt) {
        ...
        t.rt() || e.Nt.push(new te(t)), e.Nt.push(new te(Z.ot(), "asc" /* ASCENDING */)); else {
            let t = !1;
...
function cn(t) {
    ...
    return b("GRPC error has no .code"), x.UNKNOWN;
    switch (t) {
      case sn.OK:
        return x.OK;
...
class hn {
    ...
    Te() {
        if (this.he() && this.left.he()) throw D();
        if (this.right.he()) throw D();
        const t = this.left.Te();
        if (t !== this.right.Te()) throw D();
 ...
 */ class bn {
    ...
    static Me(t, e) {
        const n = new Map;
        return n.set(t, vn.Fe(t, e)), new bn(H.min(), n, Vn(), dn(), Rn());
    }
}
...
class xn {
     ...
     */    gn(t) {
        ...
        return this.hn = dn(), this.ln = $n(), this._n = new ln(W), s;
    }
    /**
    ...
    pn(t) {
        let e = this.ln.get(t);
        return e || (e = new ln(W), this.ln = this.ln.Gt(t, e)), e;
    }
    /**
...
function jn(t, e) {
    const n = Qn(e);
    if (n.get(1) !== t.p.projectId) throw new $(x.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.p.projectId);
    if (n.get(3) !== t.p.database) throw new $(x.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.p.database);
    return new tt(Jn(n));
}
...
function zn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? Y.st() : Jn(e);
}

function Hn(t) {
    return new Y([ "projects", t.p.projectId, "databases", t.p.database ]).et();
}
...
function ts(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            const e = void 0 === t.code ? x.UNKNOWN : cn(t.code);
 ...
 */ (o);
        ...
        s.document;
        const i = jn(t, s.document), r = s.readTime ? Un(s.readTime) : H.min(), o = new $t(i, r), c = s.removedTargetIds || [];
        n = new Sn([], c, o.key, o);
...
function ns(t, e) {
    const n = e.currentDocument ? function(t) {
        ...
        if ("setToServerValue" in e) C("REQUEST_TIME" === e.setToServerValue), n = new Se; else if ("appendMissingElements" in e) {
            ...
            n = new Ne(t);
        } else "increment" in e ? n = new $e(t, e.increment) : D();
        const s = Z.ct(e.fieldPath);
        return new Me(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
...
function as(t) {
    return t ? void 0 !== t.unaryFilter ? [ Es(t) ] : void 0 !== t.fieldFilter ? [ ws(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => as(t))).reduce(((t, e) => t.concat(e))) : D() : [];
}
 ...
 */ class As {
    ...
    next(t, e) {
        return this.Nn && D(), this.Nn = !0, this.Cn ? this.error ? this.xn(e, this.error) : this.$n(t, this.result) : new As(((n, s) => {
            this.Sn = e => {
                this.$n(t, e).next(n, s);
            }, this.Dn = t => {
...
class Rs {
    ...
    abort(t) {
        t && this.Ln.reject(t), this.aborted || (p("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 */ class Ps {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === Ps.Un(c()) && b("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return p("SimpleDb", "Removing database:", t), bs(window.indexedDB.deleteDatabase(t)).On();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static Kn() {
        ...
        // Check the UA string to find out the browser.
                const t = c(), e = Ps.Un(t), n = 0 < e && e < 10, s = Ps.Wn(t), i = 0 < s && s < 4.5;
        // IE 10
     ...
     */    async zn(t) {
        return this.db || (p("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new $(x.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new gs(t, s));
            }, s.onupgradeneeded = t => {
...
class Ds {
     ...
     */    cancel(t) {
        null !== this.Ts && (this.clearTimeout(), this.ws.reject(new $(x.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    Is() {
 ...
 */ function Cs(t, e) {
    if (b("AsyncQueue", `${e}: ${t}`), ys(t)) return new $(x.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ function Ms(t) {
    ...
    const e = t.length;
    if (C(e >= 2), 2 === e) return C("" === t.charAt(0) && "" === t.charAt(1)), Y.st();
...
function _i(t, e) {
    ...
    const s = e.mutations.map((e => ns(t.$s, e))), i = z.fromMillis(e.localWriteTimeMs);
    return new si(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function fi(t) {
    const e = li(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? li(t.lastLimboFreeSnapshotVersion) : H.min();
    let s;
    var i;
 ...
 */ class Ai {
    ...
    add(t) {
        const e = t.J(), n = t.G(), s = this.index[e] || new ln(Y.K), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new ln(Y.K)).tt();
    }
}
 ...
 */
async function yi(t) {
    if (t.code !== x.FAILED_PRECONDITION || t.message !== Ns) throw t;
 ...
 */ class ki {
    ...
    Ui(t) {
        return this.Bi(t).next((t => H.F(new z(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
    }
    Ki(t) {
    ...
    $i(t, e) {
        const n = $s(e.path), s = IDBKeyRange.bound([ n ], [ G(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return Li(t).us({
 ...
 */ class Ui {
    ...
    dr(t) {
        ...
        p("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this._r = this.ls.Er("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            this._r = null, this.lr = !0;
            try {
                await t.Tr(this.hr);
            } catch (t) {
                ys(t) ? p("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await yi(t);
            }
            await this.dr(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Ki {
    ...
    gr(t, e) {
        return -1 === this.params.Gs ? (p("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        As.resolve(Vi)) : this.yr(t).next((n => n < this.params.Gs ? (p("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.Gs}`), 
        Vi) : this.pr(t, e)));
    }
    yr(t) {
        return this.Ir.yr(t);
    ...
    pr(t, e) {
        ...
        e > this.params.Hs ? (p("LruGarbageCollector", `Capping sequence numbers to collect down to the maximum of ${this.params.Hs} from ${e}`), 
        s = this.params.Hs) : s = e, r = Date.now(), this.Rr(t, s)))).next((s => (n = s, 
        c = Date.now(), this.Yi(t, n, e)))).next((e => (i = e, a = Date.now(), this.Vr(t, n)))).next((t => {
            if (u = Date.now(), g() <= o.DEBUG) {
 ...
 */ class ji {
     ...
     */    Mr(t) {
        if (t) {
            ...
            return e instanceof $t && e.version.isEqual(H.min()) ? null : e;
        }
        return null;
    }
}
...
class Gi extends bi {
    ...
    di(t) {
        const e = [];
        let n = 0, s = new ln(((t, e) => W(t.et(), e.et())));
        return this.ii.forEach(((i, r) => {
            ...
            if (r.ui) {
                ...
                const n = ci(this.Wr.Ut, new $t(i, H.min()), this.oi(i));
 ...
 */
        function(t) {
            ...
            /*highestTargetId=*/ 0, 
            /*lastListenSequenceNumber=*/ 0, H.min().q(), 
            /*targetCount=*/ 0);
...
class tr {
    ...
    u) {
        ...
        this.ao = t => Promise.resolve(), !tr.Kn()) throw new $(x.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
 ...
 */
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.ho.runTransaction(t, s, ti, (s => (i = new ei(s, this.no ? this.no.next() : U.O), 
        "readwrite-primary" === e ? this.Vo(i).next((t => !!t || this.po(i))).next((e => {
            ...
            this.Xr.yo((() => this.ao(!1))), new $(x.FAILED_PRECONDITION, Ns);
            return n(i);
    ...
    Wo(t) {
        return er(t).get(Ls.key).next((t => {
            if (null !== t && this.No(t.leaseTimestampMs, 5e3) && !this.Oo(t.ownerId) && !this.So(t) && !(this.eo || this.allowTabSynchronization && t.allowTabSynchronization)) throw new $(x.FAILED_PRECONDITION, Zi);
        }));
    }
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    bo(t) {
        const e = er(t);
        return e.get(Ls.key).next((t => this.So(t) ? (p("IndexedDbPersistence", "Releasing primary lease."), 
 ...
 */ class cr {
    ...
    /** Returns all local documents matching the specified query. */    Kr(t, e, n, s) {
        ...
        }(e) || n.isEqual(H.min()) ? this.ac(t, e) : this.cc.Yo(t, s).next((i => {
            const r = this.uc(e, i);
            return (ce(e) || ae(e)) && this.hc(e.limitType, r, s, n) ? this.ac(t, e) : (g() <= o.DEBUG && p("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Te(e)), 
    ...
    ac(t, e) {
        return g() <= o.DEBUG && p("QueryEngine", "Using full collection scan to execute query:", Te(e)), 
        this.cc.Kr(t, e, H.min());
    }
}
...
class ar {
    ...
    t, e, n, s) {
         ...
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.dc = H.min(), this.Go = t.Uo(n), this.wc = t.Nr(), this.lo = t.vr(), this.Ec = new rr(this.wc, this.Go, this.persistence.Ko()), 
...
i) {
    ...
    return n.forEach((t => r = r.add(t))), e.getEntries(t, r).next((t => {
        ...
        return n.forEach(((n, o) => {
            ...
            // cache.
            o instanceof $t && o.version.isEqual(H.min()) ? (
            ...
            r = r.Gt(n, o)) : p("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", c.version, " Watch version:", o.version);
        })), r;
    }));
}
...
async function Tr(t, e, n) {
    const s = N(t), i = s._c.get(e), r = n ? "readwrite" : "readwrite-primary";
    try {
 ...
 */ function Ir(t, e, n) {
    ...
    })).next((() => s.lc.Kr(t, e, n ? i : H.min(), n ? r : Rn()))).next((t => ({
        documents: t,
        Ac: r
    })))));
}
...
// PORTING NOTE: Multi-Tab only.
function mr(t, e) {
    const n = N(t), s = N(n.lo), i = n._c.get(e);
...
async function Pr(t, e, n, s) {
    ...
    const a = i.wc.Cr({
        ...
        return fe(oe(Y.nt(`__bundle__/docs/${t}`)));
    }(s));
    // Allocates a target to hold all document keys from the bundle, such that
    // they will not get garbage collected right away.
        return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => dr(t, a, o, H.min(), c).next((e => (a.apply(t), 
...
async function Vr(t, e, n = Rn()) {
    ...
    const s = await Er(t, fe(wi(e.bundledQuery))), i = N(t);
 ...
 */ class yr {
     ...
     * removed.
     */    $c(t) {
        const e = new tt(new Y([])), n = new pr(e, t), s = new pr(e, t + 1), i = [];
    ...
    kc(t) {
        const e = new tt(new Y([])), n = new pr(e, t), s = new pr(e, t + 1);
        let i = Rn();
        return this.Sc.Ie([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
...
class pr {
    ...
    /** Compare by key then by ID */    static vc(t, e) {
        return tt.K(t.key, e.key) || W(t.Mc, e.Mc);
    }
    /** Compare by ID then by key */    static Dc(t, e) {
        return W(t.Mc, e.Mc) || tt.K(t.key, e.key);
    }
}
...
class Cr {
     ...
     */
    constructor(t, e) {
        this.Jc = {}, this.no = new U(0), this.so = !1, this.so = !0, this.Ei = t(this), 
        this.lo = new Dr(this);
 ...
 */ class Ur {
    constructor(t, e, n, s, i) {
        ...
        this._a = null, this.D = null, this.fa = this.da.bind(this), this.wa = new an(W), 
        this.wr = !1, 
        /**
 ...
 */ (this.persistenceKey), this.wa = this.wa.Gt(this.ha, new qr), this.ma = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    da(t) {
        ...
        if (e.storageArea === this.storage) {
            if (p("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.Ta) return void b("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Xr.yo((async () => {
                if (this.wr) {
...
class {
    ...
    yu(t, e, n, s) {
        ...
        const r = {};
        return this.bu(r, s), this.vu(t, i, r, n).then((t => (p("RestConnection", "Received: ", t), 
        t)), (e => {
            ...
            o.listenOnce(w.COMPLETE, (() => {
                try {
                    switch (o.getLastErrorCode()) {
                      ...
                      case E.TIMEOUT:
                        p("Connection", 'RPC "' + t + '" timed out'), r(new $(x.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case E.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (t && t.status && t.message) {
                                ...
                                r(new $(e, t.message));
                            } else r(new $(x.UNKNOWN, "Server responded with status " + o.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        r(new $(x.UNAVAILABLE, "Connection failed."));
                        break;
    ...
    Du(t, e) {
        const n = [ this.Vu, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], s = T(), i = I(), r = {
        ...
        a() || u() || h() || l() || _() || f() || (r.httpHeadersOverwriteParam = "$httpHeaders");
        const o = n.join("");
        p("Connection", "Creating WebChannel: " + o, r);
        ...
        // on a closed stream
                const E = new Gr({
            _u: t => {
                w ? p("Connection", "Not sending because WebChannel is closed:", t) : (d || (p("Connection", "Opening WebChannel transport."), 
                c.open(), d = !0), p("Connection", "WebChannel sending:", t), c.send(t));
            },
            fu: () => c.close()
        }), P = (t, e, n) => {
        ...
        // enough the code is exception free.
                return P(c, m.EventType.OPEN, (() => {
            w || p("Connection", "WebChannel transport opened.");
        })), P(c, m.EventType.CLOSE, (() => {
            w || (w = !0, p("Connection", "WebChannel transport closed"), E.Au());
        })), P(c, m.EventType.ERROR, (t => {
            w || (w = !0, v("Connection", "WebChannel transport errored:", t), E.Au(new $(x.UNAVAILABLE, "The operation could not be completed")));
        })), P(c, m.EventType.MESSAGE, (t => {
            var e;
            if (!w) {
                const n = t.data[0];
                C(!!n);
 ...
 */
                ...
                } else p("Connection", "WebChannel received:", n), E.Ru(n);
            }
        })), P(i, A.STAT_EVENT, (t => {
            t.stat === R.PROXY ? p("Connection", "Detected buffering proxy") : t.stat === R.NOPROXY && p("Connection", "Detected no buffering proxy");
        })), setTimeout((() => {
...
class Xr {
     ...
     */    Fu(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && p("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.$u} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
...
class Zr {
    ...
    auth() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            t((() => {
                const t = new $(x.UNKNOWN, "Fetching auth token failed: " + e.message);
                return this.ih(t);
            }));
        }));
    }
     ...
     */    nh(t) {
        return e => {
            this.Xr.Rs((() => this.Qu === t ? e() : (p("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve())));
        };
    }
}
 ...
 */ class to extends Zr {
    ...
    onMessage(t) {
        ...
        const e = ts(this.Ut, t), n = function(t) {
            ...
            return e.targetIds && e.targetIds.length ? H.min() : e.readTime ? Un(e.readTime) : H.min();
        }(t);
     ...
     */    ah(t) {
        ...
        e.database = Hn(this.Ut), e.addTarget = function(t, e) {
            ...
            return n = qt(s) ? {
                ...
                query: rs(t, s)
            }, n.targetId = e.targetId, e.resumeToken.wt() > 0 ? n.resumeToken = Bn(t, e.resumeToken) : e.Ot.L(H.min()) > 0 && (
...
class no extends class {} {
    ...
    Th() {
        if (this.Eh) throw new $(x.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Gets an auth token and invokes the provided RPC. */    yu(t, e, n) {
        return this.Th(), this.credentials.getToken().then((s => this.Uu.yu(t, e, n, s))).catch((t => {
            throw t.code === x.UNAUTHENTICATED && this.credentials._(), t;
        }));
    }
...
class so {
    ...
    Vh(t) {
        ...
        this.Ah ? (b(e), this.Ah = !1) : p("OnlineStateTracker", e);
    }
    yh() {
    ...
    e, n, s, i) {
        ...
        this.xh = [], this.$h = i, this.$h.ru((t => {
            n.Rs((async () => {
                ...
                // down our streams.
                fo(this) && (p("RemoteStore", "Restarting streams for network reachability change."), 
 ...
 */
        ...
        p("RemoteStore", "Failed to raise snapshot:", e), await mo(t, e);
    }
}
 ...
 */ async function mo(t, e, n) {
    ...
    t.ls.yo((async () => {
        p("RemoteStore", "Retrying IndexedDB access"), await n(), t.Nh.delete(1 /* IndexedDbFailed */), 
        await ro(t);
    }));
}
 ...
 */ function No(t) {
    ...
    t.Uh = function(t, e, n) {
        ...
        await Ro(t)) : (await t.Uh.stop(), t.Dh.length > 0 && (p("RemoteStore", `Stopping write stream with ${t.Dh.length} pending writes`), 
        t.Dh = []));
    }))), t.Uh;
}
 ...
 */ async function Xo(t, e, n, s) {
    ...
    t.Fl = (e, n, s) => async function(t, e, n, s) {
        ...
        return lc(t, e.targetId, o.Tl), o.snapshot;
    }(t, e, n, s);
...
/** Stops listening to the query. */ async function Zo(t, e) {
    const n = N(t), s = n.bl.get(e), i = n.vl.get(s.targetId);
    ...
    // No other queries are mapped to the target, clean up the query and the target.
        ...
        /*keepPersistedTargetData=*/ !1).then((() => {
            n.gl.Fa(s.targetId), ao(n.Pl, s.targetId), uc(n, s.targetId);
        })).catch(yi);
    } else uc(n, s.targetId), await Tr(n.ph, s.targetId, 
 ...
 */ async function tc(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = N(t), s = z.now(), i = e.reduce(((t, e) => t.add(e.key)), Rn());
            let r;
 ...
 * it.
 */ (s, t.batchId, n), await dc(s, t.ii), await Ro(s.Pl);
    } catch (t) {
 ...
 */ async function sc(t, e, n) {
    ...
    if (r) {
        ...
        let t = new an(tt.K);
        t = t.Gt(r, new $t(r, H.min()));
        const n = Rn().add(r), i = new bn(H.min(), 
        /* targetChanges= */ new Map, 
        /* targetMismatches= */ new ln(W), t, n);
        await ec(s, i), 
        ...
        s.Dl = s.Dl.remove(r), s.Cl.delete(e), fc(s);
    } else await Tr(s.ph, e, 
    /* keepPersistedTargetData */ !1).then((() => uc(s, e, n))).catch(yi);
}
...
async function ic(t, e) {
    ...
    try {
        ...
        // before listen events.
                ac(n, s, /*error=*/ null), cc(n, s), n.gl.Na(s, "acknowledged"), await dc(n, t);
    } catch (t) {
        await yi(t);
    }
}
 ...
 */ (s.ph, e);
        ...
        // listen events.
                ac(s, e, n), cc(s, e), s.gl.Na(e, "rejected", n), await dc(s, t);
    } catch (n) {
        await yi(n);
    }
}
 ...
 */ async function oc(t, e) {
    const n = N(t);
    fo(n.Pl) || p("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
...
/** Reject all outstanding callbacks waiting for pending writes to complete. */ function ac(t, e, n) {
    const s = N(t);
...
function hc(t, e) {
    ...
    const n = t.Dl.get(e);
    null !== n && (ao(t.Pl, n), t.Dl = t.Dl.remove(e), t.Cl.delete(n), fc(t));
}

function lc(t, e, n) {
    for (const s of n) if (s instanceof Wo) t.Nl.er(s.key, e), _c(t, s); else if (s instanceof jo) {
        p("SyncEngine", "Document no longer in limbo: " + s.key), t.Nl.sr(s.key, e);
        t.Nl.$i(s.key) || 
        // We removed the last reference for this key
        hc(t, s.key);
    } else D();
...
function _c(t, e) {
    ...
    t.Dl.get(n) || t.Sl.has(s) || (p("SyncEngine", "New document in limbo: " + n), t.Sl.add(s), 
    fc(t));
}
 ...
 */ function fc(t) {
    for (;t.Sl.size > 0 && t.Dl.size < t.yl; ) {
        ...
        t.Sl.delete(e);
        const n = new tt(Y.nt(e)), s = t.Ol.next();
        t.Cl.set(s, new Ho(n)), t.Dl = t.Dl.Gt(n, s), co(t.Pl, new Re(fe(oe(n.path)), s, 2 /* LimboResolution */ , U.O));
    }
}
...
async function wc(t, e) {
    ...
    if (!n.currentUser.isEqual(e)) {
        p("SyncEngine", "User change. New user:", e.i());
        ...
        function(t, e) {
            t.$l.forEach((t => {
                t.forEach((t => {
                    t.reject(new $(x.CANCELLED, e));
                }));
            })), t.$l.clear();
        }(n, "'waitForPendingWrites' promise is rejected due to a user change."), 
        // TODO(b/114226417): Consider calling this only in the primary tab.
        n.gl.qa(e, t.Ic, t.mc), await dc(n, t.Tc);
    }
}

function Ec(t, e) {
    const n = N(t), s = n.Cl.get(e);
 ...
 */ async function Tc(t, e) {
    const n = N(t), s = await Ir(n.ph, e.query, 
    /* usePreviousResults= */ !0), i = e.view.ml(s);
    return n.Ml && lc(n, e.targetId, i.Tl), i;
}
...
async function mc(t, e, n, s) {
    ...
    // other clients.
    ac(i, e, s || null), cc(i, e), function(t, e) {
        N(N(t).Go).Ci(e);
    }
    // PORTING NOTE: Multi-Tab only.
    (i.ph, e)) : D(), await dc(i, r)) : 
...
async function Ac(t, e) {
    ...
    if (pc(n), bc(n), !0 === e && !0 !== n.kl) {
        ...
        const t = n.gl.ba(), e = await Rc(n, t.tt());
        ...
        n.vl.forEach(((s, i) => {
            n.gl.Ma(i) ? t.push(i) : e = e.then((() => (uc(n, i), Tr(n.ph, i, 
            /*keepPersistedTargetData=*/ !0)))), ao(n.Pl, i);
        })), await e, await Rc(n, t), 
        // PORTING NOTE: Multi-Tab only.
        function(t) {
            const e = N(t);
            e.Cl.forEach(((t, n) => {
...
async function Rc(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            for (const t of n) {
                const e = s.bl.get(t), n = await Tc(s, e);
            ...
            e = await Er(s.ph, n), await Xo(s, Pc(n), t, 
            /*current=*/ !1);
        }
        i.push(e);
    }
...
function Vc(t) {
    const e = N(t);
    return N(N(e.ph).persistence).qo();
}

/** Applies a query target change from a different tab. */
// PORTING NOTE: Multi-Tab only.
async function gc(t, e, n, s) {
    const i = N(t);
    if (i.kl) 
    // If we receive a target state notification via WebStorage, we are
    // either already secondary or another tab has taken the primary lease.
    p("SyncEngine", "Ignoring unexpected query state notification."); else if (i.vl.has(e)) switch (n) {
      case "current":
      case "not-current":
        {
      ...
      case "rejected":
        await Tr(i.ph, e, 
        /* keepPersistedTargetData */ !0), uc(i, e, s);
        break;
...
/** Adds or removes Watch targets for queries from different tabs. */ async function yc(t, e, n) {
    const s = pc(t);
    if (s.kl) {
        for (const t of e) {
            if (s.vl.has(t)) {
...
function pc(t) {
    const e = N(t);
    return e.Pl.Sh.Fh = ec.bind(null, e), e.Pl.Sh.bn = Ec.bind(null, e), e.Pl.Sh.Mh = sc.bind(null, e), 
    e.pl.oh = Mo.bind(null, e.Vl), e.pl.Ll = Fo.bind(null, e.Vl), e;
}

function bc(t) {
    const e = N(t);
    return e.Pl.Sh.Lh = ic.bind(null, e), e.Pl.Sh.Bh = rc.bind(null, e), e;
}
 ...
 */ class Dc extends Sc {
    ...
    async initialize(t) {
        ...
        await bc(this.Jl.la), await Ro(this.Jl.Pl);
    }
    zl(t) {
        return ur(this.persistence, new cr, t.Hl, this.Ut);
    }
 ...
 */ class Cc extends Dc {
    ...
    async initialize(t) {
        ...
        await this.persistence.Ao((async t => {
            await Ac(this.Jl.la, t), this.jl && (t && !this.jl.wr ? this.jl.start(this.ph) : t || this.jl.stop());
        }));
    }
    Ql(t) {
        const e = Hr();
        if (!Ur.Kn(e)) throw new $(x.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class Nc {
    async initialize(t, e) {
        ...
        /* startAsPrimary=*/ !t.synchronizeTabs), this.gl._a = t => nc(this.la, t, 1 /* SharedClientState */), 
        this.Pl.Sh.e_ = wc.bind(null, this.la), await Do(this.Pl, this.la.Ml));
    }
    Zl(t) {
        return new $o;
    }
    ...
    Xl(t) {
        return e = this.ph, n = this.bh, s = t.ls, i = t => nc(this.la, t, 0 /* RemoteStore */), 
    ...
    terminate() {
        return async function(t) {
            const e = N(t);
            p("RemoteStore", "RemoteStore shutting down."), e.Nh.add(5 /* Shutdown */), await oo(e), 
            e.$h.ko(), 
...
class kc {
     ...
     */    static fromBase64String(t) {
        try {
            ...
            throw new $(x.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + t);
        }
    }
    /**
 ...
 */ class Mc {
     ...
     */
    constructor(...t) {
        for (let e = 0; e < t.length; ++e) if (0 === t[e].length) throw new $(x.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.f_ = new Z(t);
    }
    /**
 ...
 */
function Uc(t) {
    if (!tt.lt(t)) throw new $(x.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function Kc(t) {
    if (tt.lt(t)) throw new $(x.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
...
function jc(t, e) {
    if (e <= 0) throw new $(x.INVALID_ARGUMENT, `Function ${t}() requires a positive number, but it was: ${e}.`);
}
...
class Gc {
    constructor(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new $(x.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = true;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new $(x.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
        function(t, e, n, s) {
            if (!0 === e && !0 === s) throw new $(x.INVALID_ARGUMENT, `${t} and ${n} cannot be used together.`);
...
class Hc {
    /** @hideconstructor */
    constructor(t, e) {
        this.w_ = "(lite)", this.E_ = new Gc({}), this.T_ = !1, t instanceof q ? (this.I_ = t, 
        this.m_ = new k) : (this.A_ = t, this.I_ = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new $(x.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 */ (t), this.m_ = new M(e));
     ...
     * instance.
     */    get app() {
        if (!this.A_) throw new $(x.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.A_;
    }
    get R_() {
        return this.T_;
    ...
    g_(t) {
        if (this.T_) throw new $(x.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this.E_ = new Gc(t), void 0 !== t.credentials && (this.m_ = function(t) {
            if (!t) return new k;
            switch (t.type) {
              case "gapi":
                const e = t.client;
                ...
                new L(e, t.sessionIndex || "0");

              case "provider":
                return t.client;

              default:
                throw new $(x.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
    }
    y_() {
 ...
 */ class Yc {
     ...
     */    get parent() {
        return new Zc(this.firestore, this.v_, this.S_.path.G());
    }
    /**
     ...
     */    withConverter(t) {
        return new Yc(this.firestore, t, this.S_);
    }
}
 ...
 */ class Xc {
     ...
     */    withConverter(t) {
        return new Xc(this.firestore, t, this.C_);
    }
}
 ...
 */ class Zc extends Xc {
     ...
     */    get parent() {
        const t = this.D_.G();
        return t.Y() ? null : new Yc(this.firestore, 
     ...
     */    withConverter(t) {
        return new Zc(this.firestore, t, this.D_);
    }
}

function ta(t, e, ...n) {
    if (t instanceof Bc && (t = t.d_), qc("collection", "path", e), t instanceof Hc) {
        const s = Y.nt(e, ...n);
        return Kc(s), new Zc(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof Yc || t instanceof Zc)) throw new $(x.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = Y.nt(t.path, ...n).child(Y.nt(e));
        return Kc(s), new Zc(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 */ function ea(t, e) {
    if (t = Wc(t, Hc), qc("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new $(x.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new Xc(t, 
    /* converter= */ null, 
    /**
 ...
 */
    function(t) {
        return new ie(Y.st(), t);
    }(e));
}

function na(t, e, ...n) {
    if (t instanceof Bc && (t = t.d_), 
    // We allow omission of 'pathString' but explicitly prohibit passing in both
    // 'undefined' and 'null'.
    1 === arguments.length && (e = Q.k()), qc("doc", "path", e), t instanceof Hc) {
        const s = Y.nt(e, ...n);
        return Uc(s), new Yc(t, 
        /* converter= */ null, new tt(s));
    }
    {
        if (!(t instanceof Yc || t instanceof Zc)) throw new $(x.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t.D_.child(Y.nt(e, ...n));
        return Uc(s), new Yc(t.firestore, t instanceof Zc ? t.v_ : null, new tt(s));
    }
}
 ...
 * Firestore database.
 */ function sa(t, e) {
    return t instanceof Bc && (t = t.d_), e instanceof Bc && (e = e.d_), (t instanceof Yc || t instanceof Zc) && (e instanceof Yc || e instanceof Zc) && (t.firestore === e.firestore && t.path === e.path && t.v_ === e.v_);
}
 ...
 * Firestore database.
 */ function ia(t, e) {
    return t instanceof Bc && (t = t.d_), e instanceof Bc && (e = e.d_), t instanceof Xc && e instanceof Xc && (t.firestore === e.firestore && we(t.C_, e.C_) && t.v_ === e.v_);
}
 ...
 */ class ra {
     ...
     */
    constructor(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new $(x.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new $(x.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.N_ = t, this.x_ = e;
    }
    /**
     ...
     * with an underscore.
     */    M(t) {
        return W(this.N_, t.N_) || W(this.x_, t.x_);
    }
}
...
/** The result of parsing document data (e.g. for a setData call). */ class ca {
    constructor(t, e, n) {
...
/** The result of parsing "update" data (i.e. for an updateData call). */ class aa {
    constructor(t, 
...
/** A "context" object passed around while parsing user data. */ class ha {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */    F_(t) {
        return new ha(Object.assign(Object.assign({}, this.settings), t), this.p, this.Ut, this.ignoreUndefinedProperties, this.fieldTransforms, this.jt);
    }
    L_(t) {
        var e;
    ...
    Q_(t) {
        return Da(t, this.settings.methodName, this.settings.W_ || !1, this.path, this.settings.j_);
    }
    ...
    q_(t) {
        ...
        if (ua(this.M_) && oa.test(t)) throw this.Q_('Document fields cannot begin and end with "__"');
    }
}
...
/** Parse document data from a set() call. */ function fa(t, e, n, s, i, r = {}) {
    ...
    if (r.merge) a = new it(o.jt), u = o.fieldTransforms; else if (r.mergeFields) {
        ...
        for (const s of r.mergeFields) {
            const i = ba(e, s, n);
            if (!o.contains(i)) throw new $(x.INVALID_ARGUMENT, `Field '${i}' is specified in your field mask but missing from your input data.`);
            Ca(t, i) || t.push(i);
        }
        a = new it(t), u = o.fieldTransforms.filter((t => a.ft(t.field)));
    } else a = null, u = o.fieldTransforms;
    return new ca(new St(c), a, u);
}
...
class Ta extends Lc {
    ...
    z_(t) {
        const e = wa(this, t, 
        /*array=*/ !0), n = this.H_.map((t => Va(t, e))), s = new De(n);
...
class Ia extends Lc {
    ...
    z_(t) {
        const e = wa(this, t, 
        /*array=*/ !0), n = this.H_.map((t => Va(t, e))), s = new Ne(n);
        return new Me(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
/** Parse update data from an update() call. */ function Aa(t, e, n, s) {
    ...
    const c = new it(r);
    return new aa(o.Rt(), c, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Ra(t, e, n, s, i, r) {
    const o = t.G_(1 /* Update */ , e, n), c = [ ba(e, s, n) ], a = [ i ];
    if (r.length % 2 != 0) throw new $(x.INVALID_ARGUMENT, `Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);
    for (let t = 0; t < r.length; t += 2) c.push(ba(e, r[t])), a.push(r[t + 1]);
    const u = [], h = new Dt;
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = c.length - 1; t >= 0; --t) if (!Ca(u, c[t])) {
        const e = c[t];
        let n = a[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                n instanceof Bc && (n = n.d_);
        const s = o.U_(e);
        if (n instanceof da) 
        // Add it to the field mask, but don't add anything to updateData.
        u.push(e); else {
    ...
    const l = new it(u);
    return new aa(h.Rt(), l, o.fieldTransforms);
}
 ...
 */ function Pa(t, e, n, s = !1) {
    return Va(n, t.G_(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Va(t, e) {
    ...
    // from firestore-exp.
    t instanceof Bc && (t = t.d_), ya(t)) return pa("Unsupported field value:", e, t), 
    ga(t, e);
    if (t instanceof Lc) 
 ...
 */
    return function(t, e) {
        ...
        if (!ua(e.M_)) throw e.Q_(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        throw e.Q_(`Unsupported field value: ${Qc(t)}`);
    }
    /**
...
function ya(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof z || t instanceof ra || t instanceof kc || t instanceof Yc || t instanceof Lc);
}
 ...
 */ function ba(t, e, n) {
    ...
    // FieldPath.
    e instanceof Bc && (e = e.d_), e instanceof Mc) return e.f_;
    if ("string" == typeof e) return Sa(t, e);
    throw Da("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function Sa(t, e, n) {
    if (e.search(va) >= 0) throw Da(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return new Mc(...e.split(".")).f_;
    } catch (s) {
        throw Da(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}
...
function Da(t, e, n, s, i) {
    ...
    a += ")"), new $(x.INVALID_ARGUMENT, c + t + a);
}

/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function Ca(t, e) {
 ...
 */ class Na {
    ...
    async ef(t) {
        if (this.nf(), this.mutations.length > 0) throw new $(x.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        const e = await async function(t, e) {
            const n = N(t), s = Hn(n.Ut) + "/documents", i = {
        ...
        return e.forEach((t => {
            t instanceof $t || t instanceof xt ? this.sf(t) : D();
        })), e;
    }
    set(t, e) {
    ...
    sf(t) {
        ...
        if (n) {
            ...
            throw new $(x.ABORTED, "Document version changed between two reads.");
     ...
     */    rf(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new $(x.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
...
class xa {
    ...
    af() {
        this.ju.Fu((async () => {
            const t = new Na(this.bh), e = this.uf(t);
            e && e.then((e => {
...
class $a {
     ...
     */
    e, n) {
        this.credentials = t, this.ls = e, this.Pu = n, this.user = P.UNAUTHENTICATED, this.clientId = Q.k(), 
        this._f = () => {}, this.A = new ms, this.credentials.T((t => {
            p("FirestoreClient", "Received user=", t.uid), this.user = t, this._f(t), this.A.resolve();
        }));
    }
     ...
     */    df() {
        if (this.ls.wf) throw new $(x.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    terminate() {
        this.ls.Ef();
        const t = new ms;
...
async function Oa(t, e) {
    t.ls.Af(), p("FirestoreClient", "Initializing OfflineComponentProvider");
...
async function ka(t, e) {
    ...
    t.ff((n => t.ls.yo((() => async function(t, e) {
        const n = N(t);
        n.ls.Af(), p("RemoteStore", "RemoteStore received new credentials");
        const s = fo(n);
...
async function Ma(t) {
    return t.mf || (p("FirestoreClient", "Using default OfflineComponentProvider"), 
    await Oa(t, new Sc)), t.mf;
}

async function Fa(t) {
    return t.If || (p("FirestoreClient", "Using default OnlineComponentProvider"), await ka(t, new Nc)), 
    t.If;
}

function La(t) {
    return Ma(t).then((t => t.persistence));
}

function Ba(t) {
    return Ma(t).then((t => t.ph));
}

function qa(t) {
    return Fa(t).then((t => t.Pl));
}

function Ua(t) {
    return Fa(t).then((t => t.la));
}
 ...
 */ function ja(t, e) {
    ...
    return t.ls.Rs((async () => async function(t, e, n) {
        try {
            ...
            s instanceof xt ? n.resolve(s) : s instanceof $t ? n.resolve(null) : n.reject(new $(x.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
        } catch (t) {
    ...
    return t.ls.Rs((async () => function(t, e, n, s, i) {
        const r = new $c({
            next: r => {
                ...
                i.reject(new $(x.UNAVAILABLE, "Failed to get document because the client is offline.")) : c && r.fromCache && s && "server" === s.source ? i.reject(new $(x.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(r);
            },
            error: t => i.reject(t)
        ...
        return Oo(t, o);
    }(await Ka(t), t.ls, e, n, s))), s.promise;
}
    ...
    return t.ls.Rs((async () => function(t, e, n, s, i) {
        const r = new $c({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.Rs((() => ko(t, o))), n.fromCache && "server" === s.source ? i.reject(new $(x.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Bo(n, r, {
            includeMetadataChanges: !0,
...
class tu {
    constructor() {
        ...
        this.vf = () => {
            const t = Jr();
            t && p("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.ju.Bu();
        };
        const t = Jr();
 ...
 */ function ru(e, n) {
    ...
    if (void 0 !== n.cacheSizeBytes && -1 !== n.cacheSizeBytes && n.cacheSizeBytes < 1048576) throw new $(x.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    return s.g_(n), s;
}
 ...
 */ function uu(t, e) {
    mu(t = Wc(t, iu));
    const n = cu(t), s = t.p_(), i = new Nc;
    return lu(n, i, new Dc(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function hu(t) {
    mu(t = Wc(t, iu));
    const e = cu(t), n = t.p_(), s = new Nc;
    return lu(e, s, new Cc(s, n.cacheSizeBytes));
}
 ...
 */ function lu(t, e, n) {
    ...
    return t.ls.enqueue((async () => {
        try {
            await Oa(t, n), await ka(t, e), s.resolve();
        } catch (t) {
            if (!
            /**
...
function _u(t) {
    if (t.R_ && !t.P_) throw new $(x.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
    const e = new ms;
 ...
 */ function fu(t) {
    return function(t) {
        const e = new ms;
        return t.ls.Rs((async () => oc(await Ua(t), e))), e.promise;
    }(cu(t = Wc(t, iu)));
}
 ...
 */ function Tu(t, e) {
    const n = cu(t = Wc(t, iu)), s = new nu;
    return Xa(n, t.I_, e, s), s;
}
 ...
 */ function Iu(t, e) {
    return Za(cu(t = Wc(t, iu)), e).then((e => e ? new Xc(t, null, e.query) : null));
}

function mu(t) {
    if (t.R_ || t.P_) throw new $(x.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
...
class Au {
    ...
    Gf(t) {
        return new ra(at(t.latitude), at(t.longitude));
    }
    zf(t, e) {
    ...
    Jf(t, e) {
        const n = Y.nt(t);
        C(Is(n));
        const s = new q(n.get(1), n.get(3)), i = new tt(n.j(5));
        return s.isEqual(e) || 
 ...
 */ class Ru {
     ...
     */    get ref() {
        return new Yc(this.Yf, this.v_, this.S_);
    }
    /**
 ...
 * Helper that calls fromDotSeparatedString() but wraps any error thrown.
 */ function Vu(t, e) {
    return "string" == typeof e ? Sa(t, e) : e instanceof Bc ? e.d_.f_ : e.f_;
}
 ...
 */ class bu {
     ...
     */    docChanges(t = {}) {
        ...
        if (e && this.ed.Ce) throw new $(x.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 * limitations under the License.
 */ function Du(t) {
    if (ae(t) && 0 === t.Ct.length) throw new $(x.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
class xu extends Cu {
    ...
    rd(t) {
        const e = _a(t.firestore), n = function(t, e, n, s, i, r, o) {
            let c;
            if (i.rt()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === r || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === r) throw new $(x.INVALID_ARGUMENT, `Invalid Query. You can't perform '${r}' queries on FieldPath.documentId().`);
            ...
            return function(t, e) {
                if (e.Dt()) {
                    const n = he(t);
                    if (null !== n && !n.isEqual(e.field)) throw new $(x.INVALID_ARGUMENT, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${e.field.toString()}'`);
                    const s = ue(t);
 ...
 */
        ...
        return new Xc(t.firestore, t.v_, function(t, e) {
...
class Ou extends Cu {
    ...
    rd(t) {
        const e = function(t, e, n) {
            if (null !== t.startAt) throw new $(x.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new $(x.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            const s = new te(e, n);
            return function(t, e) {
                if (null === ue(t)) {
...
class Mu extends Cu {
    ...
    rd(t) {
        return new Xc(t.firestore, t.v_, de(t.C_, this.ld, this._d));
    }
}
 ...
 * @returns The created `Query`.
 */ function Fu(t) {
    return jc("limit", t), new Mu("limit", t, "F" /* First */);
}
 ...
 * @returns The created `Query`.
 */ function Lu(t) {
    return jc("limitToLast", t), new Mu("limitToLast", t, "L" /* Last */);
}
...
/** Helper function to create a bound from a document or fields */ function ju(t, e, n, s) {
    if (n[0] instanceof Bc && (n[0] = n[0].d_), n[0] instanceof Ru) return function(t, e, n, s, i) {
        if (!s) throw new $(x.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ${n}().`);
        const r = [];
        ...
        // results.
            ...
            if (ht(t)) throw new $(x.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
                const t = n.field.et();
                throw new $(x.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a document for which the field '${t}' (used as the orderBy) does not exist.`);
            }
            r.push(t);
        }
        return new Xt(r, i);
 ...
 */ (t.C_, t.firestore.I_, e, n[0].Zf, s);
    {
        const i = _a(t.firestore);
        return function(t, e, n, s, i, r) {
            // Use explicit order by's because it has to match the query the user made
            const o = t.Ct;
            if (i.length > o.length) throw new $(x.INVALID_ARGUMENT, `Too many arguments provided to ${s}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
            const c = [];
            for (let r = 0; r < i.length; r++) {
                const a = i[r];
                if (o[r].field.rt()) {
                    if ("string" != typeof a) throw new $(x.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof a}`);
                    if (!le(t) && -1 !== a.indexOf("/")) throw new $(x.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
                    const n = t.path.child(Y.nt(a));
                    if (!tt.lt(n)) throw new $(x.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new tt(n);
                    c.push(Vt(e, i));
                } else {
                    const t = Pa(n, s, a);
...
function Gu(t, e, n) {
    if (n instanceof Bc && (n = n.d_), "string" == typeof n) {
        if ("" === n) throw new $(x.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!le(e) && -1 !== n.indexOf("/")) throw new $(x.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const s = e.path.child(Y.nt(n));
        if (!tt.lt(s)) throw new $(x.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return Vt(t, new tt(s));
    }
    if (n instanceof Yc) return Vt(t, n.S_);
    throw new $(x.INVALID_ARGUMENT, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${Qc(n)}.`);
}
 ...
 * array requirements.
 */ function zu(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new $(x.INVALID_ARGUMENT, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
    if (t.length > 10) throw new $(x.INVALID_ARGUMENT, `Invalid Query. '${e.toString()}' filters support a maximum of 10 elements in the value array.`);
}

function Hu(t, e, n) {
    if (!n.isEqual(e)) throw new $(x.INVALID_ARGUMENT, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`);
}
 ...
 */ class Xu {
    /** @hideconstructor */
    constructor(t, e) {
        this.Yf = t, this.wd = e, this.Ed = [], this.Td = !1, this.Id = _a(t);
    }
    set(t, e, n) {
        this.md();
        const s = Zu(t, this.Yf), i = Ju(s.v_, e, n), r = fa(this.Id, "WriteBatch.set", s.S_, i, null !== s.v_, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return e instanceof Bc && (e = e.d_), r = "string" == typeof e || e instanceof Mc ? Ra(this.Id, "WriteBatch.update", i.S_, e, n, s) : Aa(this.Id, "WriteBatch.update", i.S_, e), 
    ...
    md() {
        if (this.Td) throw new $(x.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}

function Zu(t, e) {
    if (t instanceof Bc && (t = t.d_), t.firestore !== e) throw new $(x.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
function th(t) {
    t = Wc(t, Yc);
    const e = Wc(t.firestore, iu);
    return Ga(cu(e), t.S_).then((n => dh(e, t, n)));
}
 ...
 */ function nh(t) {
    t = Wc(t, Yc);
    const e = Wc(t.firestore, iu), n = cu(e), s = new eh(e);
    return ja(n, t.S_).then((n => new yu(e, s, t.S_, n, new gu(n instanceof xt && n.gt, 
    /* fromCache= */ !0), t.v_)));
}
 ...
 */ function ih(t) {
    t = Wc(t, Xc);
    const e = Wc(t.firestore, iu), n = cu(e), s = new eh(e);
    return Du(t.C_), Ha(n, t.C_).then((n => new bu(e, s, t, n)));
}
 ...
 */ function rh(t) {
    t = Wc(t, Xc);
    const e = Wc(t.firestore, iu), n = cu(e), s = new eh(e);
    return za(n, t.C_).then((n => new bu(e, s, t, n)));
}
...
function ch(t, e, n) {
    t = Wc(t, Yc);
    const s = Wc(t.firestore, iu), i = Ju(t.v_, e, n);
    return fh(s, [ fa(_a(s), "setDoc", t.S_, i, null !== t.v_, n).O_(t.S_, Be.Kt()) ]);
}

function ah(t, e, n, ...s) {
    t = Wc(t, Yc);
    const i = Wc(t.firestore, iu), r = _a(i);
    let o;
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e instanceof Bc && (e = e.d_), o = "string" == typeof e || e instanceof Mc ? Ra(r, "updateDoc", t.S_, e, n, s) : Aa(r, "updateDoc", t.S_, e);
 ...
 */ function uh(t) {
    return fh(Wc(t.firestore, iu), [ new tn(t.S_, Be.Kt()) ]);
}
 ...
 */ function hh(t, e) {
    const n = Wc(t.firestore, iu), s = na(t), i = Ju(t.v_, e);
    return fh(n, [ fa(_a(t.firestore), "addDoc", s.S_, i, null !== t.v_, {}).O_(s.S_, Be.exists(!1)) ]).then((() => s));
}
...
function lh(t, ...e) {
    ...
    let a, u, h;
    if (t instanceof Yc) u = Wc(t.firestore, iu), h = oe(t.S_.path), a = {
        next: n => {
            e[o] && e[o](dh(u, t, n));
        },
        error: e[o + 1],
    ...
    return function(t, e, n, s) {
        const i = new $c(s), r = new Bo(e, i, n);
        return t.ls.Rs((async () => Oo(await Ka(t), r))), () => {
            i.s_(), t.ls.Rs((async () => ko(await Ka(t), r)));
        };
    }(cu(u), h, c, a);
}

function _h(t, e) {
    return Ja(cu(t = Wc(t, iu)), eu(e) ? e : {
        next: e
    });
}
...
/** Locally writes `mutations` on the async queue. */ function fh(t, e) {
    return function(t, e) {
        const n = new ms;
        return t.ls.Rs((async () => tc(await Ua(t), e, n))), n.promise;
    }(cu(t), e);
}
 ...
 */ class wh extends class {
    /** @hideconstructor */
    constructor(t, e) {
        this.Yf = t, this.Ad = e, this.Id = _a(t);
    }
    /**
    ...
    set(t, e, n) {
        const s = Zu(t, this.Yf), i = Ju(s.v_, e, n), r = fa(this.Id, "Transaction.set", s.S_, i, null !== s.v_, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return e instanceof Bc && (e = e.d_), r = "string" == typeof e || e instanceof Mc ? Ra(this.Id, "Transaction.update", i.S_, e, n, s) : Aa(this.Id, "Transaction.update", i.S_, e), 
 ...
 * writes.
 */ function Ph(t) {
    return cu(t = Wc(t, iu)), new Xu(t, (e => fh(t, e)));
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ n(new i("firestore-exp", (t => ((t, e) => new iu(t, e))(t.getProvider("app-exp").getImmediate(), t.getProvider("auth-internal"))), "PUBLIC" /* PUBLIC */)), 
s("firestore-exp", "2.1.6", "node");

export { kc as Bytes, su as CACHE_SIZE_UNLIMITED, Zc as CollectionReference, Yc as DocumentReference, yu as DocumentSnapshot, Mc as FieldPath, Lc as FieldValue, iu as FirebaseFirestore, $ as FirestoreError, ra as GeoPoint, nu as LoadBundleTask, Xc as Query, Cu as QueryConstraint, pu as QueryDocumentSnapshot, bu as QuerySnapshot, gu as SnapshotMetadata, z as Timestamp, wh as Transaction, Xu as WriteBatch, hh as addDoc, Ah as arrayRemove, mh as arrayUnion, _u as clearIndexedDbPersistence, ta as collection, ea as collectionGroup, uh as deleteDoc, Th as deleteField, wu as disableNetwork, na as doc, Fc as documentId, uu as enableIndexedDbPersistence, hu as enableMultiTabIndexedDbPersistence, du as enableNetwork, Wu as endAt, Qu as endBefore, th as getDoc, nh as getDocFromCache, sh as getDocFromServer, ih as getDocs, rh as getDocsFromCache, oh as getDocsFromServer, ou as getFirestore, Rh as increment, ru as initializeFirestore, Fu as limit, Lu as limitToLast, Tu as loadBundle, Iu as namedQuery, lh as onSnapshot, _h as onSnapshotsInSync, ku as orderBy, Nu as query, ia as queryEqual, sa as refEqual, Eh as runTransaction, Ih as serverTimestamp, ch as setDoc, y as setLogLevel, Su as snapshotEqual, Uu as startAfter, qu as startAt, Eu as terminate, ah as updateDoc, Jc as useFirestoreEmulator, fu as waitForPendingWrites, $u as where, Ph as writeBatch };
