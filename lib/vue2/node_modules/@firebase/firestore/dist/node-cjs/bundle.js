...
function loadBundle(data) {
    return databaseFf481de8.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return databaseFf481de8.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new databaseFf481de8.Query$1(_this, 
...
registerBundle(databaseFf481de8.Firestore);
