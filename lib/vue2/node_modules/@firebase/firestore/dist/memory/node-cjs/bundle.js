...
function loadBundle(data) {
    return database92a9bc9c.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return database92a9bc9c.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new database92a9bc9c.Query$1(this, 
...
registerBundle(database92a9bc9c.Firestore);
