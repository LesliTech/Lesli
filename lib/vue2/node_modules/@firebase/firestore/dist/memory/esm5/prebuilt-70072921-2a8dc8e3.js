...
import { __extends as y, __awaiter as m, __generator as g, __spreadArrays as w } from "tslib";
 ...
 */ function T(t) {
    ...
    if (E.logLevel <= e.DEBUG) {
        var i = n.map(D);
        E.debug.apply(E, w([ "Firestore (8.2.7): " + t ], i));
    }
}
...
function N(t) {
    ...
    if (E.logLevel <= e.ERROR) {
        var i = n.map(D);
        E.error.apply(E, w([ "Firestore (8.2.7): " + t ], i));
    }
}
...
function A(t) {
    ...
    if (E.logLevel <= e.WARN) {
        var i = n.map(D);
        E.warn.apply(E, w([ "Firestore (8.2.7): " + t ], i));
    }
}
...
var U = {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            ...
            throw new x(U.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
...
q.R = new q("google-credentials-uid"), q.P = new q("first-party-uid");
...
var F = function(t, e) {
    ...
    function t(t) {
        ...
        this.currentUser = q.UNAUTHENTICATED, this.C = !1, 
        /**
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.N !== e ? (T("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (O("string" == typeof n.accessToken), new F(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.$ = function() {
        ...
        return O(null === t || "string" == typeof t), new q(t);
    }, t;
}(), G = /** @class */ function() {
    function t(t, e) {
        this.F = t, this.O = e, this.type = "FirstParty", this.user = q.P;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new G(this.F, this.O));
    }, t.prototype.v = function(t) {
...
/** A CredentialsProvider that always yields an empty token. */ Q.q = -1;
...
var H = /** @class */ function() {
     ...
     */
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new x(U.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new x(U.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
    ...
    return y(e, t), e.prototype.J = function(t, n, r) {
        return new e(t, n, r);
    ...
    e.ot = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var u = o[i];
            if (u.indexOf("//") >= 0) throw new x(U.INVALID_ARGUMENT, "Invalid segment (" + u + "). Paths must not contain // in them.");
...
}(W), K = /^[_a-zA-Z][_a-zA-Z0-9]*$/, Z = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return y(e, t), e.prototype.J = function(t, n, r) {
    ...
    e.lt = function(t) {
        for (var n = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new x(U.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            n.push(r), r = "";
        }, u = !1; i < t.length; ) {
            var s = t[i];
            if ("\\" === s) {
                if (i + 1 === t.length) throw new x(U.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new x(U.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === s ? (u = !u, i++) : "." !== s || u ? (r += s, i++) : (o(), i++);
        }
        if (o(), u) throw new x(U.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new e(n);
    }, e.ct = function() {
        return new e([]);
    }, e;
...
}(), rt = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function pt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return L(t.arrayValue.values || [], e.arrayValue.values || [], pt);
...
function vt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = C(ot(t.latitude), ot(e.latitude));
            return 0 !== n ? n : C(ot(t.longitude), ot(e.longitude));
...
function yt(t, e) {
    ...
    var n = it(t), r = it(e), i = C(n.seconds, r.seconds);
...
/** Returns true if `value` is an IntegerValue . */ function _t(t) {
 ...
 */ var Nt = /** @class */ function() {
    ...
    t.prototype.field = function(t) {
        ...
        for (var e = this.proto, n = 0; n < t.length - 1; ++n) {
            ...
            if (!Tt(e = e.mapValue.fields[t.get(n)])) return null;
        }
    ...
    /** Returns an ObjectValue with all mutations applied. */ t.prototype.Pt = function() {
        var t = this.yt(Z.ct(), this.At);
        return null != t ? new Nt(t) : this.It;
    }, 
    /**
    ...
    t.prototype.yt = function(t, e) {
        var n = this, r = !1, i = this.It.field(t), o = Tt(i) ? // If there is already data at the current path, base our
...
var St = function(t, e) {
    ...
    return y(e, t), e.prototype.field = function(t) {
    ...
    if (null === e.vt) {
        ...
        null !== e.collectionGroup && (n += "|cg:" + e.collectionGroup), n += "|f:", n += e.filters.map((function(t) {
            return function(t) {
                ...
                return t.field.rt() + t.op.toString() + mt(t.value);
            }(t);
        ...
        })).join(","), ft(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
        n += Yt(e.startAt)), e.endAt && (n += "|ub:", n += Yt(e.endAt)), e.vt = n;
    }
    return e.vt;
}
...
function Rt(t, e) {
    ...
    for (var n = 0; n < t.orderBy.length; n++) if (!Xt(t.orderBy[n], e.orderBy[n])) return !1;
...
var xt = /** @class */ function(t) {
     ...
     */    return y(e, t), e.create = function(t, n, r) {
        return t.ut() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.St(t, n, r) : new Mt(t, n, r) : "array-contains" /* ARRAY_CONTAINS */ === n ? new zt(t, r) : "in" /* IN */ === n ? new Gt(t, r) : "not-in" /* NOT_IN */ === n ? new Bt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new Qt(t, r) : new e(t, n, r);
    }, e.St = function(t, e, n) {
        return "in" /* IN */ === e ? new qt(t, n) : new Ft(t, n);
    }, e.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.Dt(vt(e, this.value)) : null !== e && lt(this.value) === lt(e) && this.Dt(vt(e, this.value));
...
var Mt = /** @class */ function(t) {
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this, e, n, r) || this).key = J.ft(r.referenceValue), i;
    }
    return y(e, t), e.prototype.matches = function(t) {
        var e = J.H(t.key, this.key);
        return this.Dt(e);
    }, e;
}(xt), qt = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, "in" /* IN */ , n) || this).keys = jt("in" /* IN */ , n), 
        r;
    }
    return y(e, t), e.prototype.matches = function(t) {
...
}(xt), Ft = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, "not-in" /* NOT_IN */ , n) || this).keys = jt("not-in" /* NOT_IN */ , n), 
        r;
    }
    return y(e, t), e.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** Filter that matches on key fields within an array. */ function jt(t, e) {
    var n;
    return ((null === (n = e.arrayValue) || void 0 === n ? void 0 : n.values) || []).map((function(t) {
        return J.ft(t.referenceValue);
    }));
}

/** A Filter that implements the array-contains operator. */ var zt = /** @class */ function(t) {
    function e(e, n) {
        return t.call(this, e, "array-contains" /* ARRAY_CONTAINS */ , n) || this;
    }
    return y(e, t), e.prototype.matches = function(t) {
        var e = t.field(this.field);
        return bt(e) && dt(e.arrayValue, this.value);
    }, e;
}(xt), Gt = /** @class */ function(t) {
    function e(e, n) {
...
/** A Filter that implements the IN operator. */ function Yt(t) {
    // TODO(b/29183165): Make this collision robust.
 ...
 */ function Kt(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.ut() ? J.H(J.ft(u.referenceValue), n.key) : vt(u, n.field(o.field)), 
...
/** Creates a new Query for a query that matches all documents at `path` */ function $t(t) {
    return new Jt(t);
}
 ...
 */ function oe(t) {
    ...
    if (null === e.Nt) {
        ...
        n.ut() || e.Nt.push(new Wt(n)), e.Nt.push(new Wt(Z.ht(), "asc" /* ASCENDING */)); else {
 ...
 */ function ue(t) {
    var e = V(t);
    if (!e.$t) if ("F" /* First */ === e.limitType) e.$t = Ct(e.path, e.collectionGroup, oe(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = oe(e); r < i.length; r++) {
            var o = i[r], u = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new Wt(o.field, u));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var s = e.endAt ? new Ht(e.endAt.position, !e.endAt.before) : null, a = e.startAt ? new Ht(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.$t = Ct(e.path, e.collectionGroup, n, e.filters, e.limit, s, a);
    }
    return e.$t;
}

function se(t, e, n) {
    return new Jt(t.path, t.collectionGroup, t.xt.slice(), t.filters.slice(), e, n, t.startAt, t.endAt);
}

function ae(t, e) {
    return Rt(ue(t), ue(e)) && t.limitType === e.limitType;
}
...
function fe(t) {
    return "Query(target=" + function(t) {
        ...
        t.filters.length > 0 && (e += ", filters: [" + t.filters.map((function(t) {
            return (e = t).field.rt() + " " + e.op + " " + mt(e.value);
            /** Returns a debug description for `filter`. */            var e;
            /** Filter that matches on key fields (i.e. '__name__'). */        })).join(", ") + "]"), 
        ft(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return function(t) {
                return t.field.rt() + " (" + t.dir + ")";
            }(t);
        })).join(", ") + "]"), t.startAt && (e += ", startAt: " + Yt(t.startAt)), t.endAt && (e += ", endAt: " + Yt(t.endAt)), 
        "Target(" + e + ")";
    }(ue(t)) + "; limitType=" + t.limitType + ")";
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function he(t, e) {
    return function(t, e) {
        ...
        return !(t.startAt && !Kt(t.startAt, oe(t), e)) && (!t.endAt || !Kt(t.endAt, oe(t), e));
    }(t, e);
}
...
function pe(t, e, n) {
    var r = t.field.ut() ? J.H(e.key, n.key) : function(t, e, n) {
        var r = e.field(t), i = n.field(t);
        return null !== r && null !== i ? vt(r, i) : S();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 */ var de = /** @class */ function() {
     ...
     */ , u) {
        void 0 === i && (i = Y.min()), void 0 === o && (o = Y.min()), void 0 === u && (u = R.T), 
 ...
 * limitations under the License.
 */
/** Used to represent a field transform on a mutation. */ var ge = function() {
 ...
 */ function we(t, e, n) {
    ...
    }(n, e) : t instanceof Ie ? Te(t, e) : t instanceof Ne ? Ae(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = be(t, e), r = Se(n) + Se(t.Ut);
        return _t(n) && _t(t.Ut) ? ye(r) : ve(t.Qt, r);
    }(t, e);
}
 ...
 */ function _e(t, e, n) {
    ...
    // applications.
    return t instanceof Ie ? Te(t, e) : t instanceof Ne ? Ae(t, e) : n;
}
 ...
 */ function be(t, e) {
    return t instanceof De ? _t(n = e) || function(t) {
 ...
 */ function Re(t, e, n) {
    return t instanceof Fe ? function(t, e, n) {
        ...
        return new Ot(t.key, n.version, r, {
        ...
        var r = ze(t, e, n.transformResults ? Ge(t.fieldTransforms, e, n.transformResults) : []);
        return new Ot(t.key, n.version, r, {
            hasCommittedMutations: !0
        });
 ...
 */ function Ue(t, e, n) {
    return t instanceof Fe ? function(t, e, n) {
        if (!Ce(t.jt, e)) return e;
        var r = t.value, i = Be(t.fieldTransforms, n, e);
        r = Qe(t.fieldTransforms, r, i);
        var o = qe(e);
        return new Ot(t.key, o, r, {
            Vt: !0
        });
    }(t, e, n) : t instanceof je ? function(t, e, n) {
        if (!Ce(t.jt, e)) return e;
        var r = qe(e), i = ze(t, e, Be(t.fieldTransforms, n, e));
        return new Ot(t.key, r, i, {
            Vt: !0
        });
    }(t, e, n) : function(t, e) {
        return Ce(t.jt, e) ? new Vt(t.key, Y.min()) : e;
    }(t, e);
}
 ...
 */ function xe(t, e) {
    return function(t, e) {
        for (var n = null, r = 0, i = t; r < i.length; r++) {
            var o = i[r], u = e instanceof Ot ? e.field(o.field) : void 0, s = be(o.transform, u || null);
            null != s && (n = null == n ? (new At).set(o.field, s) : n.set(o.field, s));
        }
        return n ? n.Pt() : null;
    }(t.fieldTransforms, e);
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && L(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Ie && e instanceof Ie || t instanceof Ne && e instanceof Ne ? L(t.elements, e.elements, pt) : t instanceof De && e instanceof De ? pt(t.Ut, e.Ut) : t instanceof Ee && e instanceof Ee;
 ...
 */ function qe(t) {
    return t instanceof Ot ? t.version : Y.min();
}

/**
 * A mutation that creates or replaces the document at the given key with the
 * object value contents.
 */ var Fe = /** @class */ function(t) {
    function e(e, n, r, i) {
        void 0 === i && (i = []);
        var o = this;
...
function ze(t, e, n) {
    ...
    }(t, r = e instanceof Ot ? e.data() : Nt.empty()), r = Qe(t.fieldTransforms, r, n);
}
...
function Ge(t, e, n) {
    ...
    for (var i = 0; i < n.length; i++) {
        ...
        e instanceof Ot && (s = e.field(o.field)), r.push(_e(u, s, n[i]));
    }
    return r;
}
 ...
 */ function Be(t, e, n) {
    for (var r = [], i = 0, o = t; i < o.length; i++) {
        ...
        n instanceof Ot && (a = n.field(u.field)), r.push(we(s, a, e));
    }
    return r;
}

function Qe(t, e, n) {
    for (var r = new At(e), i = 0; i < t.length; i++) {
        var o = t[i];
        r.set(o.field, n[i]);
    }
    return r.Pt();
...
/** A mutation that deletes the document at the given key. */ var He, Ye, We = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
 ...
 */ function Je(t) {
    ...
    return N("GRPC error has no .code"), U.UNKNOWN;
    switch (t) {
      case He.OK:
        return U.OK;
 ...
 *     Code.UNKNOWN.
 */ (Ye = He || (He = {}))[Ye.OK = 0] = "OK", Ye[Ye.CANCELLED = 1] = "CANCELLED", 
Ye[Ye.UNKNOWN = 2] = "UNKNOWN", Ye[Ye.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", 
Ye[Ye.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", Ye[Ye.NOT_FOUND = 5] = "NOT_FOUND", 
Ye[Ye.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", Ye[Ye.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", 
Ye[Ye.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", Ye[Ye.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", 
Ye[Ye.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", Ye[Ye.ABORTED = 10] = "ABORTED", 
Ye[Ye.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", Ye[Ye.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", 
Ye[Ye.INTERNAL = 13] = "INTERNAL", Ye[Ye.UNAVAILABLE = 14] = "UNAVAILABLE", Ye[Ye.DATA_LOSS = 15] = "DATA_LOSS";
...
var $e = /** @class */ function() {
    function t(t, e) {
        this.H = t, this.root = e || en.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.zt = function(e, n) {
        return new t(this.H, this.root.zt(e, n, this.H).copy(null, null, en.Ht, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.H, this.root.remove(e, this.H).copy(null, null, en.Ht, null, null));
    }, 
    ...
    t.prototype.te = function() {
        return new tn(this.root, null, this.H, !1);
    }, t.prototype.ee = function(t) {
        return new tn(this.root, t, this.H, !1);
    }, t.prototype.ne = function() {
        return new tn(this.root, null, this.H, !0);
    }, t.prototype.se = function(t) {
        return new tn(this.root, t, this.H, !0);
    }, t;
}(), tn = /** @class */ function() {
    function t(t, e, n, r) {
        this.ie = r, this.re = [];
    ...
    t.prototype.Ie = function() {
        if (this.le() && this.left.le()) throw S();
        if (this.right.le()) throw S();
        var t = this.left.Ie();
        if (t !== this.right.Ie()) throw S();
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
en.EMPTY = null, en.RED = !0, en.Ht = !1, 
// end LLRBEmptyNode
en.EMPTY = new (/** @class */ function() {
    function t() {
        this.size = 0;
    }
...
var nn = /** @class */ function() {
    function t(t) {
        this.H = t, this.data = new $e(this.H);
    }
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.Re = function(t) {
        ...
        return new rn(this.data.te());
    }, t.prototype.ee = function(t) {
        return new rn(this.data.ee(t));
    }, 
 ...
 */ var yn = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.H = t ? function(e, n) {
            return t(e, n) || J.H(e.key, n.key);
        } : function(t, e) {
            return J.H(t.key, e.key);
        }, this.ge = cn(), this.Ve = new $e(this.H)
        /**
    ...
    return t.Ne = function(e, n, r, i) {
        ...
        if (!(this.fromCache === t.fromCache && this.Ce === t.Ce && this.De.isEqual(t.De) && ae(this.query, t.query) && this.docs.isEqual(t.docs) && this.Se.isEqual(t.Se))) return !1;
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, _n.Le(e, n)), new t(Y.min(), r, vn(), un(), pn());
    }, t;
}(), _n = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = R.T), void 0 === r && (r = null), this.state = t, this.targetIds = e, 
    ...
    return t.prototype.dn = function(t) {
        for (var e = 0, n = t.Ke; e < n.length; e++) {
            var r = n[e];
            t.We instanceof Ot ? this.wn(r, t.We) : t.We instanceof Vt && this.En(r, t.key, t.We);
        }
    ...
    t.prototype.Pn = function(t) {
        ...
        if (r) {
            ...
            if (Ut(i)) if (0 === n) {
                ...
                // queries.
                var o = new J(i.path);
                this.En(e, o, new Vt(o, Y.min()));
            } else O(1 === n); else this.gn(e) !== n && (
    ...
    t.prototype.Vn = function(t) {
        ...
        var i = new wn(t, n, this.fn, this.ln, r);
        return this.ln = un(), this._n = An(), this.fn = new nn(C), i;
    }, 
    /**
    ...
    t.prototype.on = function(t) {
        ...
        var e = this.hn.get(t);
        return e || (e = new Tn, this.hn.set(t, e)), e;
    }, t.prototype.bn = function(t) {
        var e = this._n.get(t);
        return e || (e = new nn(C), this._n = this._n.zt(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Rn = function(t) {
        var e = this;
        this.hn.set(t, new Tn), this.un.vn(t).forEach((function(n) {
...
function xn(t, e) {
    return Rn(t.t, e.path);
}

function Mn(t, e) {
    var n = Un(e);
    if (n.get(1) !== t.t.projectId) throw new x(U.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.t.projectId);
    if (n.get(3) !== t.t.database) throw new x(U.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.t.database);
    return new J(jn(n));
}
...
function Fn(t) {
    return new X([ "projects", t.t.projectId, "databases", t.t.database ]).rt();
}

function jn(t) {
    return O(t.length > 4 && "documents" === t.get(4)), t.Y(5)
...
function Qn(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = qn(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = qn(t, r.X()), n.structuredQuery.from = [ {
        collectionId: r.tt()
    } ]);
    var i = function(t) {
        if (0 !== t.length) {
    ...
    return null !== u && (n.structuredQuery.limit = u), e.startAt && (n.structuredQuery.startAt = Wn(e.startAt)), 
...
function Hn(t) {
    ...
    var u = [];
    n.where && (u = Yn(n.where));
    var s = [];
    n.orderBy && (s = n.orderBy.map((function(t) {
        return function(t) {
            return new Wt($n(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    n.limit && (a = function(t) {
        var e;
        return ft(e = "object" == typeof t ? t.value : t) ? null : e;
    }(n.limit));
    var c = null;
    n.startAt && (c = Xn(n.startAt));
    var f = null;
    return n.endAt && (f = Xn(n.endAt)), function(t, e, n, r, i, o, u, s) {
        return new Jt(t, e, n, r, i, o, u, s);
    }(e, i, s, u, a, "F" /* First */ , c, f);
}

function Yn(t) {
    return t ? void 0 !== t.unaryFilter ? [ er(t) ] : void 0 !== t.fieldFilter ? [ tr(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return Yn(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : S() : [];
...
function $n(t) {
    return Z.lt(t.fieldPath);
}

function tr(t) {
    return xt.create($n(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function er(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        var e = $n(t.unaryFilter.field);
        return xt.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        var n = $n(t.unaryFilter.field);
        return xt.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        var r = $n(t.unaryFilter.field);
        return xt.create(r, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        var i = $n(t.unaryFilter.field);
 ...
 */ var ir = function() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.Nn && S(), this.Nn = !0, this.xn ? this.error ? this.$n(n, this.error) : this.Fn(e, this.result) : new t((function(t, i) {
            r.Dn = function(n) {
                r.Fn(e, n).next(t, i);
            }, r.Cn = function(e) {
                r.$n(n, e).next(t, i);
 ...
 */ var sr = /** @class */ function() {
    function t(t, e, n, r, i) {
        this._s = t, this.fs = e, this.ds = n, this.op = r, this.ws = i, this.Es = new ir, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.Is && (this.clearTimeout(), this.Es.reject(new x(U.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
 ...
 */ function ar(t, e) {
    if (N("AsyncQueue", e + ": " + t), ur(t)) return new x(U.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var cr = /** @class */ function() {
    ...
    t.prototype.Cs = function(t, e) {
        ...
        for (var n = 0, r = this.baseMutations; n < r.length; n++) {
            (u = r[n]).key.isEqual(t) && (e = Ue(u, e, this.vs));
        }
        // Second, apply all user-provided mutations.
                for (var i = 0, o = this.mutations; i < o.length; i++) {
            var u;
            (u = o[i]).key.isEqual(t) && (e = Ue(u, e, this.vs));
        }
        return e;
    }, 
    /**
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = hn(), o = e.mutations, u = 0; u < o.length; u++) i = i.zt(o[u].key, r[u].version);
 ...
 */ var dr = /** @class */ function() {
    ...
    return t.prototype.qs = function(t, e) {
        return this.Bs.add(e), or.resolve();
    }, t.prototype.Us = function(t, e) {
        return or.resolve(this.Bs.getEntries(e));
    }, t;
}(), vr = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.tt(), n = t.X(), r = this.index[e] || new nn(X.H), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.tt(), n = t.X(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new nn(X.H)).it();
    }, t;
}();
...
function yr(t) {
    return m(this, void 0, void 0, (function() {
        return g(this, (function(e) {
            if (t.code !== U.FAILED_PRECONDITION || "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab." !== t.message) throw t;
...
var mr = /** @class */ function() {
    ...
    t.prototype._i = function(t, e) {
        this.ui();
        var n = this.ri.get(e);
        return void 0 !== n ? or.resolve(n.hi) : this.fi(t, e);
    }, 
    /**
    ...
    t.prototype.Zo = function(t, e) {
        ...
        return this.zo.vi(t, e).next((function(r) {
            var i = n.Yo(t, e, r), o = un();
            return i.forEach((function(t, e) {
                // TODO(http://b/32275378): Don't conflate missing / deleted.
                e || (e = new Vt(t, Y.min())), o = o.zt(t, e);
            })), o;
        }));
    }, 
    /**
 ...
 */
        return function(t) {
            return J.wt(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.tc(t, e.path) : ie(e) ? this.ec(t, e, n) : this.nc(t, e, n);
    }, t.prototype.tc = function(t, e) {
        // Just do a simple document lookup.
        return this.Ho(t, new J(e)).next((function(t) {
            var e = cn();
            return t instanceof Ot && (e = e.zt(t.key, t)), e;
        }));
    }, t.prototype.ec = function(t, e, n) {
        var r = this, i = e.collectionGroup, o = cn();
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.sc(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], u = 0, s = o.mutations; u < s.length; u++) {
                    var a = s[u], c = a.key, f = Ue(a, r.get(c), o.vs);
                    r = f instanceof Ot ? r.zt(c, f) : r.remove(c);
                }
            }));
        })).next((function() {
        ...
        for (var r = pn(), i = 0, o = e; i < o.length; i++) for (var u = 0, s = o[i].mutations; u < s.length; u++) {
            var a = s[u];
        ...
        return this.fo.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof Ot && (c = c.zt(t, e));
            })), c;
        }));
    }, t;
}(), Er = /** @class */ function() {
    ...
    return t.oc = function(e, n) {
        for (var r = pn(), i = pn(), o = 0, u = n.docChanges; o < u.length; o++) {
            var s = u[o];
            switch (s.type) {
              case 0 /* Added */ :
                r = r.add(s.doc.key);
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.Kr = function(t, n, r, i) {
        ...
        }(n) || r.isEqual(Y.min()) ? this.uc(t, n) : this.ac.Xo(t, i).next((function(u) {
            var s = o.hc(n, u);
            return (te(n) || ee(n)) && o.lc(n.limitType, s, i, r) ? o.uc(t, n) : (I() <= e.DEBUG && T("QueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), fe(n)), 
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.hc = function(t, e) {
        ...
        return e.forEach((function(e, r) {
            r instanceof Ot && he(t, r) && (n = n.add(r));
        })), n;
    }, 
    /**
    ...
    t.prototype.lc = function(t, e, n, r) {
        ...
        return I() <= e.DEBUG && T("QueryEngine", "Using full collection scan to execute query:", fe(n)), 
        this.ac.Kr(t, n, Y.min());
    }, t;
}(), Tr = /** @class */ function() {
    function t(
    ...
    t, e, n, r) {
        ...
        /**
             ...
             */
        this.wc = Y.min(), this.zo = t.Qo(n), this.Ec = t.$r(), this._o = t.Sr(), this.Tc = new br(this.Ec, this.zo, this.persistence.Ko()), 
...
function Nr(t, e) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(u) {
            switch (u.label) {
              case 0:
                return n = V(t), r = n.zo, i = n.Tc, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n.zo.pi(t).next((function(u) {
                        ...
                        // MutationQueue.
                        i = new br(n.Ec, r, n.persistence.Ko()), r.pi(t);
                    })).next((function(e) {
                        for (var n = [], r = [], u = pn(), s = 0, a = o
        ...
        return function(t, e, n, r) {
            ...
            return o.forEach((function(t) {
                u = u.next((function() {
                    ...
                    var o = e, u = n.$s.get(t);
                    O(null !== u), (!o || o.version._(u) < 0) && ((o = i.Ss(t, o, n)) && 
 ...
 */ function Sr(t, e) {
     ...
     */
                    function(t, e, n) {
                        ...
                        return O(e.resumeToken.l() > 0), 0 === t.resumeToken.l() || (
        ...
        u.push(Or(t, o, e.Oe, r, void 0).next((function(t) {
            s = t;
        }))), !r.isEqual(Y.min())) {
...
i) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, u) {
            ...
            // cache.
                        u instanceof Vt && u.version.isEqual(Y.min()) ? (
            ...
            o = o.zt(n, u)) : T("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", s.version, " Watch version:", u.version);
        })), o;
    }))
    /**
 ...
 */ function kr(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n._o.tr(t, e).next((function(i) {
            ...
            r = i, or.resolve(r)) : n._o.Bi(t).next((function(i) {
                return r = new de(e, i, 0 /* Listen */ , t.bs), n._o.ji(t, r).next((function() {
                    return r;
                }));
            }));
        }));
...
function Pr(t, e, n) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(s) {
            switch (s.label) {
              case 0:
                r = V(t), i = r.fc.get(e), o = n ? "readwrite" : "readwrite-primary", s.label = 1;
              ...
              case 4:
                if (!ur(u = s.sent())) throw u;
                // All `releaseTarget` does is record the final metadata state for the
                // target, but we've been recording this periodically during target
                // activity. If we lose this write this could cause a very slight
                // difference in the order of target deletion during GC, but we
                // don't define exact LRU semantics so this is acceptable.
                                return T("LocalStore", "Failed to update sequence numbers for target " + e + ": " + u), 
                [ 3 /*break*/ , 5 ];
 ...
 */ function Cr(t, e, n) {
    var r = V(t), i = Y.min(), o = pn();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = V(t), i = r.dc.get(n);
            return void 0 !== i ? or.resolve(r.fc.get(i)) : r._o.tr(e, n);
        }(r, t, ue(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r._o.rr(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r._c.Kr(t, e, n ? i : Y.min(), n ? o : pn());
        })).next((function(t) {
            return {
                documents: t,
                Rc: o
 ...
 */ function Lr(t, e, n, r) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(d) {
            switch (d.label) {
              case 0:
                for (i = V(t), o = pn(), u = un(), s = hn(), a = 0, c = n; a < c.length; a++) f = c[a], 
                h = e.Pc(f.metadata.name), f.document && (o = o.add(h)), u = u.zt(h, e.yc(f)), s = s.zt(h, e.gc(f.metadata.readTime));
                return l = i.Ec.Nr({
                    Wr: !0
                }), [ 4 /*yield*/ , kr(i, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return ue($t(X.ot("__bundle__/docs/" + t)));
                }(r)) ];
              ...
              case 1:
                ...
                return p = d.sent(), [ 2 /*return*/ , i.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return Or(t, l, u, Y.min(), s).next((function(e) {
                        return l.apply(t), e;
                    })).next((function(e) {
 ...
 */ function Rr(t, e, n) {
    return void 0 === n && (n = pn()), m(this, void 0, void 0, (function() {
        var r, i;
        return g(this, (function(o) {
            switch (o.label) {
              case 0:
                return [ 4 /*yield*/ , kr(t, ue(pr(e.bundledQuery))) ];

              case 1:
                return r = o.sent(), [ 2 /*return*/ , (i = V(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    var o = Ln(e.readTime);
 ...
 */ var Ur = /** @class */ function() {
    ...
    return t.prototype.Os = function(t, e) {
        return or.resolve(this.Vc.get(e));
    ...
    function t() {
        ...
        this.vc = new nn(Mr.Sc), 
        // A set of outstanding references to a document sorted by target id.
        this.Dc = new nn(Mr.Cc)
    ...
    t.prototype.Fc = function(t) {
        var e = this, n = new J(new X([])), r = new Mr(n, t), i = new Mr(n, t + 1), o = [];
        ...
        var e = new J(new X([])), n = new Mr(e, t), r = new Mr(e, t + 1), i = pn();
        return this.Dc.me([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.Fi = function(t) {
        var e = new Mr(t, 0), n = this.vc.Re(e);
    ...
    return t.Sc = function(t, e) {
        return J.H(t.key, e.key) || C(t.Mc, e.Mc);
    }, 
    /** Compare by ID then by key */ t.Cc = function(t, e) {
        return C(t.Mc, e.Mc) || J.H(t.key, e.key);
    }, t;
}(), qr = /** @class */ function() {
    function t(t, e) {
        this.Ei = t, this.Ti = e, 
    ...
    return t.prototype.Ai = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                J.wt(i) || (i = i.child(""));
        var o = new Mr(new J(i), 0), u = new nn(C);
        ...
        var n = this;
        O(0 === this.Kc(e.batchId, "removed")), this.zo.shift();
        var r = this.Bc;
        ...
        var n = new Mr(e, 0), r = this.Bc.Re(n);
        return or.resolve(e.isEqual(r && r.key));
    }, t.prototype.$i = function(t) {
        return this.zo.length, or.resolve();
    }, 
    /**
    ...
    t.prototype.li = function(t) {
        ...
        for (var r = cn(), i = new J(e.path.child("")), o = this.docs.ee(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.ce(); ) {
            var u = o.oe(), s = u.key, a = u.value, c = a.hi, f = a.readTime;
            if (!e.path.nt(s.path)) break;
            f._(n) <= 0 || c instanceof Ot && he(e, c) && (r = r.zt(c.key, c));
        }
        return or.resolve(r);
    ...
    return y(e, t), e.prototype.wi = function(t) {
        var e = this, n = [];
...
}(gr), zr = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.Gc = new mr((function(t) {
            return Lt(t);
        }), Rt), 
        ...
        /**
             ...
             * IDs.
             */
        this.Hc = new xr, this.targetCount = 0, this.Jc = wr.Mi();
    }
    return t.prototype.In = function(t, e) {
        ...
        return or.resolve(this.zc);
    }, t.prototype.Bi = function(t) {
        return this.highestTargetId = this.Jc.next(), or.resolve(this.highestTargetId);
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.Jc = new wr(e), this.highestTargetId = e), t.sequenceNumber > this.zc && (this.zc = t.sequenceNumber);
    }, t.prototype.ji = function(t, e) {
        return this.Gi(e), this.targetCount += 1, or.resolve();
    }, t.prototype.Hi = function(t, e) {
        return this.Gi(e), or.resolve();
    }, t.prototype.Ji = function(t, e) {
        ...
        return this.Hc.xc(e, n), or.resolve();
        ...
        return this.Hc.Fc(e), or.resolve();
    }, t.prototype.rr = function(t, e) {
        var n = this.Hc.kc(e);
        return or.resolve(n);
    }, t.prototype.Fi = function(t, e) {
        return or.resolve(this.Hc.Fi(e));
    }, t;
}(), Gr = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        ...
        this._o = new zr(this), this.Ei = new dr, this.fo = function(t, e) {
            return new Fr(t, (function(t) {
                return n.Ti.Xc(t);
            }));
        }(this.Ei), this.Qt = new lr(e), this.wo = new Ur(this.Qt);
    }
    return t.prototype.start = function() {
        ...
        var e = this.Yc[t.A()];
        return e || (e = new qr(this.Ei, this.Ti), this.Yc[t.A()] = e), e;
        ...
        return or.Ln(Object.values(this.Yc).map((function(n) {
            return function() {
                return n.Fi(t, e);
            };
        })));
    ...
    return t.ia = function(e) {
        ...
        return this.na.nr(n, e), this.ra.delete(n.toString()), or.resolve();
    }, t.prototype.ir = function(t, e, n) {
        return this.na.ir(n, e), this.ra.add(n.toString()), or.resolve();
    }, t.prototype.Ni = function(t, e) {
        return this.ra.add(e.toString()), or.resolve();
        ...
        // Remove newly orphaned documents.
                return or.forEach(this.ra, (function(r) {
            var i = J._t(r);
        ...
        var n = this;
        return or.Ln([ function() {
            return or.resolve(n.na.Fi(e));
        }, function() {
    ...
    function t() {
        this.iu = new Hr, this.ru = {}, this.fa = null, this.k = null;
    }
    return t.prototype.Ca = function(t) {
        ...
        return this.iu = new Hr, Promise.resolve();
     ...
     * HTTP).
     */
    return y(e, t), e.prototype.Su = function(t, e, n, r) {
            ...
            u.listenOnce(c.COMPLETE, (function() {
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case f.TIMEOUT:
                        T("Connection", 'RPC "' + t + '" timed out'), o(new x(U.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case f.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new x(s, r.message));
                            } else o(new x(U.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new x(U.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var a = [ this.gu, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], c = h(), f = l(), y = {
        ...
        this.vu(y.initMessageHeaders, e), 
        ...
        var m = a.join("");
        T("Connection", "Creating WebChannel: " + m, y);
        var g = c.createWebChannel(m, y), w = !1, _ = !1, b = new Zr({
            fu: function(t) {
                _ ? T("Connection", "Not sending because WebChannel is closed:", t) : (w || (T("Connection", "Opening WebChannel transport."), 
                g.open(), w = !0), T("Connection", "WebChannel sending:", t), g.send(t));
            },
            du: function() {
                return g.close();
            }
        ...
        return E(g, p.EventType.OPEN, (function() {
            _ || T("Connection", "WebChannel transport opened.");
        })), E(g, p.EventType.CLOSE, (function() {
            _ || (_ = !0, T("Connection", "WebChannel transport closed"), b.Ru());
        })), E(g, p.EventType.ERROR, (function(t) {
            _ || (_ = !0, A("Connection", "WebChannel transport errored:", t), b.Ru(new x(U.UNAVAILABLE, "The operation could not be completed")));
        })), E(g, p.EventType.MESSAGE, (function(t) {
            var e;
            if (!_) {
                var n = t.data[0];
                O(!!n);
 ...
 */
                    ...
                    void 0 === u && (u = U.INTERNAL, s = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    _ = !0, b.Ru(new x(u, s)), g.close();
                } else T("Connection", "WebChannel received:", n), b.Pu(n);
            }
        })), E(f, d.STAT_EVENT, (function(t) {
            t.stat === v.PROXY ? T("Connection", "Detected buffering proxy") : t.stat === v.NOPROXY && T("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
 ...
 * some target ID.
 */
/** The Platform's 'document' implementation or null if not available. */ function $r() {
 ...
 */ var ei = /** @class */ function() {
    ...
    t.prototype.Lu = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && T("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Fu + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.Wu = 0, this.ju = null, this.stream = null, this.Gu = new ei(t, e)
        /**
    ...
    t.prototype.nh = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new x(U.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.rh(e);
            }));
        }));
    ...
    t.prototype.sh = function(t) {
        ...
        return function(n) {
            e.Zr.Ps((function() {
                return e.Wu === t ? n() : (T("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return y(e, t), e.prototype.oh = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.Bt ? (O(void 0 === e || "string" == typeof e), R.fromBase64String(e || "")) : (O(void 0 === e || e instanceof Uint8Array), 
                    R.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), u = (s = e.targetChange.cause) && function(t) {
                    var e = void 0 === t.code ? U.UNKNOWN : Je(t.code);
                    return new x(e, t.message || "");
                }(s);
                n = new In(r, i, o, u || null);
            } else if ("documentChange" in e) {
                e.documentChange, (r = e.documentChange).document, r.document.name, r.document.updateTime, 
                i = Mn(t, r.document.name), o = Ln(r.document.updateTime);
                var s = new Nt({
                    mapValue: {
                        fields: r.document.fields
                    }
                }), a = (u = new Ot(i, o, s, {}), r.targetIds || []), c = r.removedTargetIds || [];
                n = new bn(a, c, u.key, u);
            } else if ("documentDelete" in e) e.documentDelete, (r = e.documentDelete).document, 
            i = Mn(t, r.document), o = r.readTime ? Ln(r.readTime) : Y.min(), s = new Vt(i, o), 
            u = r.removedTargetIds || [], n = new bn([], u, s.key, s); else if ("documentRemove" in e) e.documentRemove, 
            (r = e.documentRemove).document, i = Mn(t, r.document), o = r.removedTargetIds || [], 
            n = new bn([], o, i, null); else {
                if (!("filter" in e)) return S();
                e.filter;
                var f = e.filter;
                f.targetId, r = f.count || 0, i = new Ke(r), o = f.targetId, n = new En(o, i);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? Y.min() : e.readTime ? Ln(e.readTime) : Y.min();
        }(t);
    ...
    e.prototype.uh = function(t) {
        var e = {};
        e.database = Fn(this.Qt), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = Ut(r) ? {
                documents: Bn(t, r)
            } : {
                query: Qn(t, r)
            }).targetId = e.targetId, e.resumeToken.l() > 0 ? n.resumeToken = Pn(t, e.resumeToken) : e.Ot._(Y.min()) > 0 && (
            // TODO(wuandy): Consider removing above check because it is most likely true.
            // Right now, many tests depend on this behaviour though (leaving min() out
            // of serialization).
            n.readTime = kn(t, e.Ot.j())), n;
        }(this.Qt, t);
        var n = function(t, e) {
            var n = function(t, e) {
                switch (e) {
    ...
    e.prototype.hh = function(t) {
        var e = {};
        e.database = Fn(this.Qt), e.removeTarget = t, this.th(e);
    }, e;
}(ni), ii = /** @class */ function(t) {
    function e(e, n, r, i, o) {
        var u = this;
    ...
    return y(e, t), Object.defineProperty(e.prototype, "_h", {
        /**
    ...
    e.prototype.start = function() {
        ...
        O(!!t.streamToken), this.lastStreamToken = t.streamToken, this.lh) {
        ...
        // The first response is always the handshake response
                return O(!t.writeResults || 0 === t.writeResults.length), this.lh = !0, 
        this.listener.wh();
    }, 
    /**
    ...
    e.prototype.Eh = function() {
        ...
        var t = {};
        t.database = Fn(this.Qt), this.th(t);
    }, 
...
}(ni), oi = /** @class */ function(t) {
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this) || this).credentials = e, i.Qu = n, i.Qt = r, i.Th = !1, 
        i;
    }
    return y(e, t), e.prototype.Ih = function() {
        if (this.Th) throw new x(U.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ e.prototype.pu = function(t, e, n) {
        ...
        return this.Ih(), this.credentials.getToken().then((function(i) {
            ...
            throw t.code === U.UNAUTHENTICATED && r.credentials.p(), t;
        }));
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.Rh ? (N(e), this.Rh = !1) : T("OnlineStateTracker", e);
...
e, n, r, i) {
    ...
    this.$h = [], this.Fh = i, this.Fh.ou((function(t) {
        n.Ps((function() {
            return m(o, void 0, void 0, (function() {
                return g(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return yi(this) ? (T("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return m(this, void 0, void 0, (function() {
                                var e;
                                return g(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = V(t)).Nh.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , ci(e) ];
 ...
 */ function hi(t, e) {
    var n = V(t), r = ki(n);
    n.xh.delete(e), r.Hu() && pi(n, e), 0 === n.xh.size && (r.Hu() ? r.Xu() : yi(n) && 
...
function vi(t) {
    return yi(t) && !ki(t).zu() && t.xh.size > 0;
}

function yi(t) {
    return 0 === V(t).Nh.size;
}
...
function _i(t, e, n) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(u) {
            switch (u.label) {
              case 0:
                if (t.Oh.set("Online" /* Online */), !(e instanceof In && 2 /* Removed */ === e.state && e.cause)) 
              ...
              case 3:
                return r = u.sent(), T("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), r), 
                [ 4 /*yield*/ , bi(t, r) ];
              ...
              case 6:
                if (e instanceof bn ? t.kh.dn(e) : e instanceof En ? t.kh.Pn(e) : t.kh.Tn(e), n.isEqual(Y.min())) return [ 3 /*break*/ , 13 ];
                u.label = 7;

              case 7:
                return u.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , Dr(t.bh) ];
                ...
                function(t, e) {
                    ...
                    n.Fe.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            var r = new de(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            li(t, r);
                        }
                    })), t.Dh.Lh(n);
                }(t, n) ] : [ 3 /*break*/ , 10 ];
              ...
              case 11:
                return T("RemoteStore", "Failed to raise snapshot:", o = u.sent()), [ 4 /*yield*/ , bi(t, o) ];
        ...
        return g(this, (function(i) {
            switch (i.label) {
              case 0:
                ...
                return t.Nh.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , ci(t) ];
                ...
                t._s.po((function() {
                    return m(r, void 0, void 0, (function() {
                        return g(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return T("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , n() ];

                              case 1:
                                return e.sent(), t.Nh.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , ai(t) ];
...
function Ii(t) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(u) {
            switch (u.label) {
              case 0:
                e = V(t), n = Pi(e), r = e.Ch.length > 0 ? e.Ch[e.Ch.length - 1].batchId : -1, u.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return u.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , Vr(e.bh, r) ];
              ...
              case 4:
                return o = u.sent(), [ 4 /*yield*/ , bi(e, o) ];
...
function Ti(t) {
    return yi(t) && !Pi(t).zu() && t.Ch.length > 0;
}
...
function Di(t) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(o) {
            ...
            for (e = Pi(t), n = 0, r = t.Ch; n < r.length; n++) i = r[n], e.fh(i.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function Si(t, e, n) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(o) {
            switch (o.label) {
              case 0:
                return r = t.Ch.shift(), i = hr.from(r, e, n), [ 4 /*yield*/ , Ei(t, (function() {
                    return t.Dh.Bh(i);
                })) ];
...
function Oi(t, e) {
    return m(this, void 0, void 0, (function() {
        return g(this, (function(n) {
            switch (n.label) {
              case 0:
                return e && Pi(t)._h ? [ 4 /*yield*/ , function(t, e) {
                    return m(this, void 0, void 0, (function() {
                        var n, r;
                        return g(this, (function(i) {
                            switch (i.label) {
                              case 0:
                                return Ze(r = e.code) && r !== U.ABORTED ? (n = t.Ch.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                Pi(t).Yu(), [ 4 /*yield*/ , Ei(t, (function() {
 ...
 */ function Vi(t, e) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(i) {
            switch (i.label) {
              case 0:
                return n = V(t), e ? (n.Nh.delete(2 /* IsSecondary */), [ 4 /*yield*/ , ai(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return i.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (r = e) ? [ 3 /*break*/ , 4 ] : (n.Nh.add(2 /* IsSecondary */), [ 4 /*yield*/ , ci(n) ]);
 ...
 */ function ki(t) {
    ...
    t.Uh = function(t, e, n) {
        var r = V(t);
        return r.Ih(), new ri(e, r.Qu, r.credentials, r.Qt, n);
    }(t.Sh, t._s, {
        wu: gi.bind(null, t),
        Tu: wi.bind(null, t),
        ah: _i.bind(null, t)
        ...
        return m(e, void 0, void 0, (function() {
            return g(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n ? (t.Uh.Yu(), vi(t) ? di(t) : t.Oh.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , t.Uh.stop() ];

                  case 2:
                    e.sent(), mi(t), e.label = 3;
...
function Pi(t) {
    ...
    t.Qh = function(t, e, n) {
        var r = V(t);
        return r.Ih(), new ii(e, r.Qu, r.credentials, r.Qt, n);
    }(t.Sh, t._s, {
        wu: Ai.bind(null, t),
        Tu: Oi.bind(null, t),
        wh: Di.bind(null, t),
        ...
        return m(e, void 0, void 0, (function() {
            return g(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n ? (t.Qh.Yu(), [ 4 /*yield*/ , Ii(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 3:
                    e.sent(), t.Ch.length > 0 && (T("RemoteStore", "Stopping write stream with " + t.Ch.length + " pending writes"), 
                    t.Ch = []), e.label = 4;
...
var Ci = function() {
    ...
    this.queries = new mr((function(t) {
        return ce(t);
    }), ae), this.onlineState = "Unknown" /* Unknown */ , this.Wh = new Set;
};
...
function Ri(t, e) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(c) {
            switch (c.label) {
              case 0:
                if (n = V(t), r = e.query, i = !1, (o = n.queries.get(r)) || (i = !0, o = new Ci), 
                !i) return [ 3 /*break*/ , 4 ];
                c.label = 1;
              ...
              case 3:
                return s = c.sent(), a = ar(s, "Initialization of query '" + fe(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(a) ];

              case 4:
                return n.queries.set(r, o), o.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.Gh(n.onlineState), o.Kh && e.zh(o.Kh) && qi(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
...
function Ui(t, e) {
    return m(this, void 0, void 0, (function() {
        var n, r, i, o, u;
        return g(this, (function(s) {
            return n = V(t), r = e.query, i = !1, (o = n.queries.get(r)) && (u = o.listeners.indexOf(e)) >= 0 && (o.listeners.splice(u, 1), 
...
function xi(t, e) {
    for (var n = V(t), r = !1, i = 0, o = e; i < o.length; i++) {
 ...
 */ var Fi = /** @class */ function() {
    ...
    return t.prototype.zh = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new gn(t.query, t.docs, t.Se, e, t.De, t.fromCache, t.Ce, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.Gh = function(t) {
        ...
        t = gn.Ne(t.query, t.docs, t.De, t.fromCache), this.Yh = !0, this.Jh.next(t);
    }, t;
}(), ji = /** @class */ function() {
    function t(t, 
    ...
    t.prototype.yc = function(t) {
        return t.metadata.exists ? function(t, e, n) {
            var r = Mn(t, e.name), i = Ln(e.updateTime), o = new Nt({
                mapValue: {
                    fields: e.fields
                }
            });
        ...
        }(this.Qt, t.document, !1) : new Vt(this.Pc(t.metadata.name), this.gc(t.metadata.readTime));
    ...
    function t(t, e, n) {
        ...
        this.documents = [], this.progress = Bi(t)
        /**
    ...
    t.prototype.complete = function() {
        return m(this, void 0, void 0, (function() {
            ...
            return g(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return [ 4 /*yield*/ , Lr(this.bh, new zi(this.Qt), this.documents, this.il.id) ];

                  case 1:
                    t = o.sent(), e = this.ol(this.documents), n = 0, r = this.queries, o.label = 2;

                  case 2:
                    return n < r.length ? (i = r[n], [ 4 /*yield*/ , Rr(this.bh, i, e.get(i.name)) ]) : [ 3 /*break*/ , 5 ];
                  ...
                  case 5:
                    return [ 2 /*return*/ , (this.progress.taskState = "Success", new _r(Object.assign({}, this.progress), t)) ];
                }
            }));
        }));
    }, t;
 ...
 */ var Qi = function(t) {
    ...
    e) {
        ...
        this.De = pn(), this.hl = le(t), this.ll = new yn(this.hl);
    }
    ...
    t.prototype.fl = function(t, e) {
        var n = this, r = e ? e.dl : new mn, i = e ? e.ll : this.ll, o = e ? e.De : this.De, u = i, s = !1, a = te(this.query) && i.size === this.query.limit ? i.last() : null, c = ee(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.Xt((function(t, e) {
            var f = i.get(t), h = e instanceof Ot ? e : null;
            h && (h = he(n.query, h) ? h : null);
            var l = !!f && n.De.has(f.key), p = !!h && (h.Vt || 
            // We only consider committed mutations for documents that were
            // mutated during the lifetime of the view.
            n.De.has(h.key) && h.hasCommittedMutations), d = !1;
            // Calculate change
            f && h ? f.data().isEqual(h.data()) ? l !== p && (r.track({
                type: 3 /* Metadata */ ,
                doc: h
            }), d = !0) : n.wl(f, h) || (r.track({
                type: 2 /* Modified */ ,
                doc: h
            }), d = !0, (a && n.hl(h, a) > 0 || c && n.hl(h, c) < 0) && (
            ...
            o = o.delete(t)));
        })), te(this.query) || ee(this.query)) for (;u.size > this.query.limit; ) {
            var f = te(this.query) ? u.last() : u.first();
    ...
    t.prototype.wi = function(t, e, n) {
        ...
        return this.al = s, 0 !== o.length || a ? {
            snapshot: new gn(this.query, t.ll, i, o, t.De, 0 /* Local */ === s, a, 
            /* excludesMetadataChanges= */ !1),
            Il: u
        } : {
            Il: u
    ...
    t.prototype.El = function(t) {
        ...
        // updating many documents.
                var e = this.ul;
        this.ul = pn(), this.ll.forEach((function(e) {
            t.ml(e.key) && (t.ul = t.ul.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.ul.has(e) || n.push(new Hi(e));
    ...
    t.prototype.Rl = function() {
        return gn.Ne(this.query, this.ll, this.De, 0 /* Local */ === this.al);
    }, t;
}(), Wi = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.bl = {}, this.vl = new mr((function(t) {
            return ce(t);
        }), ae), this.Sl = new Map, 
        /**
        ...
        /**
             ...
             */
        this.xl = new Map, this.Nl = new xr, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.$l = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Fl = new Map, this.Ol = wr.Li(), this.onlineState = "Unknown" /* Unknown */ , 
        ...
        return g(this, (function(a) {
            switch (a.label) {
              case 0:
                return n = function(t) {
                    var e = V(t);
                    return e.yl.Dh.Lh = eo.bind(null, e), e.yl.Dh.vn = mo.bind(null, e), e.yl.Dh.Mh = ro.bind(null, e), 
                    e.bl.ah = xi.bind(null, e.gl), e.bl.Bl = Mi.bind(null, e.gl), e;
                }(t), (o = n.vl.get(e)) ? (
              ...
              case 1:
                return [ 4 /*yield*/ , kr(n.bh, ue(e)) ];

              case 2:
                return u = a.sent(), s = n.Vl.Fa(u.targetId), r = u.targetId, [ 4 /*yield*/ , Ji(n, e, r, "current" === s) ];

              case 3:
                i = a.sent(), n.Ml && fi(n.yl, u), a.label = 4;
    ...
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(f) {
            switch (f.label) {
                    ...
                    return function(t, e, n, r) {
                        return m(this, void 0, void 0, (function() {
                            ...
                            return g(this, (function(s) {
                                switch (s.label) {
                                  case 0:
                                    return i = e.view.fl(n), i.lc ? [ 4 /*yield*/ , Cr(t.bh, e.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.Ml, o), [ 2 /*return*/ , (ho(t, e.targetId, u.Il), 
                                    u.snapshot) ];
                                }
                            }));
                        }));
              ...
              case 1:
                return i = f.sent(), o = new Yi(e, i.Rc), u = o.fl(i.documents), s = _n.Le(n, r && "Offline" /* Offline */ !== t.onlineState), 
                a = o.wi(u, 
                /* updateLimboDocuments= */ t.Ml, s), ho(t, n, a.Il), c = new Wi(e, n, o), [ 2 /*return*/ , (t.vl.set(e, c), 
...
/** Stops listening to the query. */ function $i(t, e) {
    return m(this, void 0, void 0, (function() {
        var n, r, i;
        return g(this, (function(o) {
            switch (o.label) {
              case 0:
                return n = V(t), r = n.vl.get(e), (i = n.Sl.get(r.targetId)).length > 1 ? [ 2 /*return*/ , (n.Sl.set(r.targetId, i.filter((function(t) {
                    return !ae(t, e);
                }))), void n.vl.delete(e)) ] : n.Ml ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                n.Vl.ka(r.targetId), n.Vl.Da(r.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Pr(n.bh, r.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.Vl.La(r.targetId), hi(n.yl, r.targetId), co(n, r.targetId);
                })).catch(yr) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return co(n, r.targetId), [ 4 /*yield*/ , Pr(n.bh, r.targetId, 
        ...
        return g(this, (function(s) {
            switch (s.label) {
              case 0:
                r = function(t) {
                    var e = V(t);
                    return e.yl.Dh.Bh = io.bind(null, e), e.yl.Dh.qh = oo.bind(null, e), e
                    /**
 ...
 */;
              ...
              case 1:
                return s.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = V(t), i = H.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), pn());
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Tc.Xo(t, o).next((function(o) {
                            ...
                            var u = [], s = 0, a = e; s < a.length; s++) {
                                var c = a[s], f = xe(c, n.get(c.key));
                                null != f && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                u.push(new je(c.key, f, Dt(f.proto.mapValue), Pe.exists(!0)));
                            }
              ...
              case 2:
                return i = s.sent(), r.Vl.Ca(i.batchId), function(t, e, n) {
                    ...
                    r || (r = new $e(C)), r = r.zt(e, n), t.$l[t.currentUser.A()] = r;
                }(r, i.batchId, n), [ 4 /*yield*/ , vo(r, i.ri) ];

              case 3:
                return s.sent(), [ 4 /*yield*/ , Ii(r.yl) ];

              case 4:
                return s.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return o = s.sent(), u = ar(o, "Failed to persist write"), n.reject(u), [ 3 /*break*/ , 6 ];
    ...
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(i) {
            switch (i.label) {
              ...
              case 1:
                return i.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Sr(n.bh, e) ];
              ...
              case 2:
                ...
                e.$e.forEach((function(t, e) {
                    ...
                    O(t.qe.size + t.Ue.size + t.Qe.size <= 1), t.qe.size > 0 ? r.Pl = !0 : t.Ue.size > 0 ? O(r.Pl) : t.Qe.size > 0 && (O(r.Pl), 
                    r.Pl = !1));
                })), [ 4 /*yield*/ , vo(n, r, e) ];
    ...
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(c) {
            switch (c.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (r = V(t)).Vl.Ba(e, "rejected", n), i = r.xl.get(e), (o = i && i.key) ? (u = (u = new $e(J.H)).zt(o, new Vt(o, Y.min())), 
                s = pn().add(o), a = new wn(Y.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new nn(C), u, s), [ 4 /*yield*/ , eo(r, a) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                r.Cl = r.Cl.remove(o), r.xl.delete(e), po(r), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , Pr(r.bh, e, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return co(r, e, n);
                })).catch(yr) ];
...
function io(t, e) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(o) {
            switch (o.label) {
              case 0:
                n = V(t), r = e.batch.batchId, o.label = 1;

              case 1:
                return o.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Ar(n.bh, e) ];
              ...
              case 2:
                ...
                ao(n, r, /*error=*/ null), so(n, r), n.Vl.Na(r, "acknowledged"), [ 4 /*yield*/ , vo(n, i) ];
        ...
        return g(this, (function(o) {
            switch (o.label) {
                ...
                return o.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n.zo.Pi(t, e).next((function(e) {
                            return O(null !== e), r = e.keys(), n.zo.Ci(t, e);
                        })).next((function() {
                            return n.zo.$i(t);
                        })).next((function() {
                            return n.Tc.Xo(t, r);
              ...
              case 2:
                ...
                // listen events.
                ao(r, e, n), so(r, e), r.Vl.Na(e, "rejected", n), [ 4 /*yield*/ , vo(r, i) ];
 ...
 */ function uo(t, e) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(s) {
            switch (s.label) {
              case 0:
                yi((n = V(t)).yl) || T("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                s.label = 1;
              ...
              case 3:
                return o = s.sent(), u = ar(o, "Initialization of waitForPendingWrites() operation failed"), 
...
function ao(t, e, n) {
    var r = V(t), i = r.$l[r.currentUser.A()];
...
function fo(t, e) {
    ...
    var n = t.Cl.get(e);
    null !== n && (hi(t.yl, n), t.Cl = t.Cl.remove(e), t.xl.delete(n), po(t));
}

function ho(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Qi ? (t.Nl.nr(o.key, e), lo(t, o)) : o instanceof Hi ? (T("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function lo(t, e) {
    ...
    t.Cl.get(n) || t.Dl.has(r) || (T("SyncEngine", "New document in limbo: " + n), t.Dl.add(r), 
    po(t));
}
 ...
 */ function po(t) {
    for (;t.Dl.size > 0 && t.Cl.size < t.pl; ) {
        ...
        t.Dl.delete(e);
        var n = new J(X.ot(e)), r = t.Ol.next();
        t.xl.set(r, new Xi(n)), t.Cl = t.Cl.zt(n, r), fi(t.yl, new de(ue($t(n.path)), r, 2 /* LimboResolution */ , Q.q));
    }
}
                    ...
                    return m(this, void 0, void 0, (function() {
                        ...
                        return g(this, (function(h) {
                            switch (h.label) {
                              ...
                              case 1:
                                return h.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return or.forEach(e, (function(e) {
                                        return or.forEach(e.ic, (function(r) {
                                            return n.persistence.Ti.nr(t, e.targetId, r);
                                        })).next((function() {
                                            return or.forEach(e.rc, (function(r) {
                              ...
                              case 3:
                                if (!ur(r = h.sent())) throw r;
                                // If `notifyLocalViewChanges` fails, we did not advance the sequence
                                // number for the documents that were included in this transaction.
                                // This might trigger them to be deleted earlier than they otherwise
                                // would have, but it should not invalidate the integrity of the data.
                                                                return T("LocalStore", "Failed to update sequence numbers: " + r), 
                                [ 3 /*break*/ , 4 ];
...
function yo(t, e) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(i) {
            switch (i.label) {
              case 0:
                return (n = V(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (T("SyncEngine", "User change. New user:", e.A()), 
                [ 4 /*yield*/ , Nr(n.bh, e) ]);
              ...
              case 1:
                ...
                function(t, e) {
                    t.Fl.forEach((function(t) {
                        t.forEach((function(t) {
                            t.reject(new x(U.CANCELLED, "'waitForPendingWrites' promise is rejected due to a user change."));
                        }));
                    })), t.Fl.clear();
                }(n), 
                // TODO(b/114226417): Consider calling this only in the primary tab.
                n.Vl.Ua(e, r.mc, r.Ac), [ 4 /*yield*/ , vo(n, r.Ic) ];
...
function mo(t, e) {
    var n = V(t), r = n.xl.get(e);
    if (r && r.Pl) return pn().add(r.key);
    var i = pn(), o = n.Sl.get(e);
    if (!o) return i;
        ...
        return m(this, void 0, void 0, (function() {
            ...
            return g(this, (function(c) {
                switch (c.label) {
                  ...
                  case 4:
                    return n.Ul(Bi(r)), i = new Gi(r, t.bh, e.Qt), [ 4 /*yield*/ , e.Ql() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return s = c.sent(), [ 4 /*yield*/ , vo(t, s.Go, 
                    /* remoteEvent */ void 0) ];
                  ...
                  case 14:
                    return A("SyncEngine", "Loading bundle failed with " + (a = c.sent())), n.Kl(a), 
                    [ 3 /*break*/ , 15 ];
...
var wo = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return m(this, void 0, void 0, (function() {
            return g(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.Qt = ti(t.yu.t), this.Vl = this.Wl(t), this.persistence = this.jl(t), 
        ...
        /** Manages our in-memory or durable persistence. */
        t, e, n, r) {
            return new Tr(t, e, n, r);
        }(this.persistence, new Ir, t.Jl, this.Qt);
    }, t.prototype.jl = function(t) {
        return new Gr(Qr.ia, this.Qt);
    ...
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.Vl.fa = function(t) {
                        return no(n._a, t, 1 /* SharedClientState */);
                    }, this.yl.Dh.n_ = yo.bind(null, this._a), [ 4 /*yield*/ , Vi(this.yl, this._a.Ml) ]);
        ...
        var e, n = ti(t.yu.t), r = (e = t.yu, new Jr(e));
        ...
        return e = this.bh, n = this.Sh, r = t._s, i = function(t) {
            return no(u._a, t, 0 /* RemoteStore */);
        }, o = Xr.Kn() ? new Xr : new Wr, new si(e, n, r, i, o);
    }, t.prototype.e_ = function(t, e) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, u) {
            var s = new Ki(t, e, n, r, i, o);
            return u && (s.kl = !0), s;
        ...
        return function(t) {
            return m(this, void 0, void 0, (function() {
                ...
                return g(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = V(t), T("RemoteStore", "RemoteStore shutting down."), e.Nh.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , ci(e) ];
 ...
 */ var Eo = /** @class */ function() {
        ...
        return m(this, void 0, void 0, (function() {
            ...
            return g(this, (function(i) {
                switch (i.label) {
                  ...
                  case 2:
                    return r = i.sent(), [ 2 /*return*/ , new ji(JSON.parse(r), t.length + n) ];
                }
            }));
        }));
    }, 
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new x(U.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.f_ = new Z(t);
    }
    /**
 ...
 */
function Do(t, e, n) {
    if (!n) throw new x(U.INVALID_ARGUMENT, "Function " + t + "() cannot be called with an empty " + e + ".");
}
...
function So(t, e) {
    ...
    if (void 0 !== e.mergeFields && void 0 !== e.merge) throw new x(U.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
 ...
 */ function Oo(t, e, n, r) {
    if (!0 === e && !0 === r) throw new x(U.INVALID_ARGUMENT, t + " and " + n + " cannot be used together.");
}
 ...
 */ function Vo(t) {
    if (!J.wt(t)) throw new x(U.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function ko(t) {
    if (J.wt(t)) throw new x(U.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
...
e) {
    ...
    t = t.d_), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new x(U.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = Po(t);
        throw new x(U.INVALID_ARGUMENT, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function Lo(t, e) {
    if (e <= 0) throw new x(U.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */ var Ro = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new x(U.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new x(U.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
        Oo("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling);
    }
    return t.prototype.isEqual = function(t) {
        return this.host === t.host && this.ssl === t.ssl && this.credentials === t.credentials && this.cacheSizeBytes === t.cacheSizeBytes && this.experimentalForceLongPolling === t.experimentalForceLongPolling && this.experimentalAutoDetectLongPolling === t.experimentalAutoDetectLongPolling && this.ignoreUndefinedProperties === t.ignoreUndefinedProperties;
    }, t;
}(), Uo = new Map, xo = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this.w_ = "(lite)", this.E_ = new Ro({}), this.T_ = !1, t instanceof b ? (this.I_ = t, 
        this.m_ = new j) : (this.A_ = t, this.I_ = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new x(U.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
    ...
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this.A_) throw new x(U.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.A_;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this.T_) throw new x(U.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this.E_ = new Ro(t), void 0 !== t.credentials && (this.m_ = function(t) {
            if (!t) return new j;
            switch (t.type) {
              case "gapi":
                var e = t.client;
              ...
              default:
                throw new x(U.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */
        return t = this, (e = Uo.get(t)) && (T("ComponentProvider", "Removing Datastore"), 
        Uo.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}(), Mo = /** @class */ function() {
    /** @hideconstructor */
    ...
    return Object.defineProperty(t.prototype, "D_", {
         ...
         */
        get: function() {
            return new Fo(this.firestore, this.v_, this.S_.path.X());
        },
        enumerable: !1,
        configurable: !0
    }), 
    ...
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this, e, n, $t(r)) || this).firestore = e, i.D_ = r, i.type = "collection", 
        i;
    }
    return y(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        get: function() {
            var t = this.D_.X();
            return t.et() ? null : new Mo(this.firestore, 
 ...
 */ function jo(t, e) {
    ...
    if (t instanceof Ao && (t = t.d_), Do("collection", "path", e), t instanceof xo) return ko(n = X.ot.apply(X, w([ e ], r))), 
    new Fo(t, /* converter= */ null, n);
    if (!(t instanceof Mo || t instanceof Fo)) throw new x(U.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return ko(n = X.ot.apply(X, w([ t.path ], r)).child(X.ot(e))), new Fo(t.firestore, 
    /* converter= */ null, n);
}
 ...
 */ function zo(t, e) {
    for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
    if (t instanceof Ao && (t = t.d_), 
    // We allow omission of 'pathString' but explicitly prohibit passing in both
    // 'undefined' and 'null'.
    1 === arguments.length && (e = P.u()), Do("doc", "path", e), t instanceof xo) return Vo(n = X.ot.apply(X, w([ e ], r))), 
    new Mo(t, 
    /* converter= */ null, new J(n));
    if (!(t instanceof Mo || t instanceof Fo)) throw new x(U.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Vo(n = t.D_.child(X.ot.apply(X, w([ e ], r)))), new Mo(t.firestore, t instanceof Fo ? t.v_ : null, new J(n));
}
 ...
 * Firestore database.
 */ function Go(t, e) {
    return t instanceof Ao && (t = t.d_), e instanceof Ao && (e = e.d_), (t instanceof Mo || t instanceof Fo) && (e instanceof Mo || e instanceof Fo) && t.firestore === e.firestore && t.path === e.path && t.v_ === e.v_
    /**
...
function Bo(t, e) {
    return t instanceof Ao && (t = t.d_), e instanceof Ao && (e = e.d_), t instanceof qo && e instanceof qo && t.firestore === e.firestore && ae(t.C_, e.C_) && t.v_ === e.v_
    /**
 * @license
 * Copyright 2017 Google LLC
 *
...
var Qo = /** @class */ function() {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new x(U.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new x(U.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.x_ = t, this.N_ = e;
    }
...
}(), Ho = /^__.*__$/, Yo = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.Gt = e, this.fieldTransforms = n;
    }
    return t.prototype.F_ = function(t, e) {
        return null !== this.Gt ? new je(t, this.data, this.Gt, e, this.fieldTransforms) : new Fe(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Wo = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Ko = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.M_ = function(e) {
        ...
        return yu(t, this.settings.methodName, this.settings.W_ || !1, this.path, this.settings.j_);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Xo(this.k_) && Ho.test(t)) throw this.K_('Document fields cannot begin and end with "__"');
    }, t;
}(), Zo = /** @class */ function() {
    function t(t, e, n) {
        this.t = t, this.ignoreUndefinedProperties = e, this.Qt = n || ti(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.G_ = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Ko({
            k_: t,
            methodName: e,
            j_: n,
            path: Z.ct(),
 ...
 * classes.
 */ function Jo(t) {
    var e = t.p_(), n = ti(t.I_);
    return new Zo(t.I_, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function $o(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var u = t.G_(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    lu("Data must be an object, but it was:", u, r);
    var s, a, c = fu(r, u);
    if (o.merge) s = new nt(u.Gt), a = u.fieldTransforms; else if (o.mergeFields) {
        for (var f = [], h = 0, l = o.mergeFields; h < l.length; h++) {
            var p = pu(e, l[h], n);
            if (!u.contains(p)) throw new x(U.INVALID_ARGUMENT, "Field '" + p + "' is specified in your field mask but missing from your input data.");
            mu(f, p) || f.push(p);
        }
        s = new nt(f), a = u.fieldTransforms.filter((function(t) {
            return s.Tt(t.field);
        }));
    } else s = null, a = u.fieldTransforms;
    return new Yo(new Nt(c), s, a);
}

var tu = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return y(e, t), e.prototype.z_ = function(t) {
...
var nu = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return y(e, t), e.prototype.z_ = function(t) {
        return new Ve(t.path, new Ee);
    }, e.prototype.isEqual = function(t) {
        return t instanceof e;
    }, e;
}(No), ru = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
...
}(No), ou = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e) || this).J_ = n, r;
    }
    return y(e, t), e.prototype.z_ = function(t) {
        var e = new De(t.Qt, me(t.Qt, this.J_));
...
/** Parse update data from an update() call. */ function uu(t, e, n, r) {
    ...
    var s = new nt(o);
    return new Wo(u.Pt(), s, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function su(t, e, n, r, i, o) {
    var u = t.G_(1 /* Update */ , e, n), s = [ pu(e, r, n) ], a = [ i ];
    if (o.length % 2 != 0) throw new x(U.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) s.push(pu(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var f = [], h = new At, l = s.length - 1; l >= 0; --l) if (!mu(f, s[l])) {
        var p = s[l], d = a[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        d instanceof Ao && (d = d.d_);
        var v = u.U_(p);
        if (d instanceof tu) 
        // Add it to the field mask, but don't add anything to updateData.
        f.push(p); else {
    ...
    var m = new nt(f);
    return new Wo(h.Pt(), m, u.fieldTransforms);
}
 ...
 */ function au(t, e, n, r) {
    return void 0 === r && (r = !1), cu(n, t.G_(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function cu(t, e) {
    ...
    // from firestore-exp.
    t instanceof Ao && (t = t.d_), hu(t)) return lu("Unsupported field value:", e, t), 
    fu(t, e);
    if (t instanceof No) 
    ...
    return function(t, e) {
        ...
        if (!Xo(e.k_)) throw e.K_(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        if (t instanceof Ao && (t = t.d_), null === t) return {
            nullValue: "NULL_VALUE"
        };
        ...
        if (t instanceof H) {
            ...
            n = new H(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
                timestampValue: kn(e.Qt, n)
            };
        }
        ...
        if (t instanceof Mo) {
            ...
            return {
                referenceValue: Rn(t.firestore.I_ || e.t, t.S_.path)
            };
        }
...
function fu(t, e) {
    ...
    e.path && e.path.length > 0 && e.Gt.push(e.path) : tt(t, (function(t, r) {
        var i = cu(r, e.L_(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function hu(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof H || t instanceof Qo || t instanceof M || t instanceof Mo || t instanceof No);
}
 ...
 */ function pu(t, e, n) {
    ...
    // FieldPath.
    e instanceof Ao && (e = e.d_), e instanceof To) return e.f_;
 ...
 * evaluated.
 */ function vu(t, e, n) {
    if (e.search(du) >= 0) throw yu("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return (new (To.bind.apply(To, w([ void 0 ], e.split("."))))).f_;
    } catch (r) {
...
function yu(t, e, n, r, i) {
    ...
    a += ")"), new x(U.INVALID_ARGUMENT, (s += ". ") + t + a)
 ...
 */ var gu = /** @class */ function() {
    ...
    return t.prototype.ef = function(t) {
        return m(this, void 0, void 0, (function() {
            ...
            return g(this, (function(r) {
                switch (r.label) {
                  case 0:
                    if (this.nf(), this.mutations.length > 0) throw new x(U.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, e) {
                        return m(this, void 0, void 0, (function() {
                            ...
                            return g(this, (function(a) {
                                switch (a.label) {
                                  case 0:
                                    return n = V(t), r = Fn(n.Qt) + "/documents", i = {
                                    ...
                                    return o = a.sent(), u = new Map, o.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Mn(t, e.found.name), r = Ln(e.found.updateTime), i = new Nt({
                                                    mapValue: {
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((e = r.sent()).forEach((function(t) {
                        t instanceof Vt || t instanceof Ot ? n.sf(t) : S();
                    })), e) ];
                }
            }));
        }));
        ...
        this.write(new We(t, this.jt(t))), this.tf.add(t.toString());
                ...
                switch (n.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = J._t(n);
                        e.mutations.push(new Xe(r, e.jt(r)));
        ...
        if (n) {
            ...
            throw new x(U.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.jt = function(t) {
        ...
        return !this.tf.has(t.toString()) && e ? Pe.updateTime(e) : Pe.Kt();
    }, 
    /**
    ...
    t.prototype.rf = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new x(U.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
            // Document exists, base precondition on document update time.
                        return Pe.updateTime(e);
        }
    ...
    function t(t, e, n, r) {
        this._s = t, this.Sh = e, this.updateFunction = n, this.Es = r, this.cf = 5, this.Gu = new ei(this._s, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.Gu.Lu((function() {
            return m(t, void 0, void 0, (function() {
                var t, e, n = this;
                return g(this, (function(r) {
                    return t = new gu(this.Sh), (e = this.uf(t)) && e.then((function(e) {
                        n._s.Ps((function() {
        ...
        try {
            ...
            return !ft(e) && e.catch && e.then ? e : (this.Es.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
    ...
    e, n) {
        var r = this;
        this.credentials = t, this._s = e, this.yu = n, this.user = q.UNAUTHENTICATED, this.clientId = P.u(), 
        this._f = function() {}, this.C = new ir, this.credentials.v((function(t) {
            T("FirestoreClient", "Received user=", t.uid), r.user = t, r._f(t), r.C.resolve();
        }));
    }
    ...
    t.prototype.df = function() {
        if (this._s.wf) throw new x(U.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.terminate = function() {
        var t = this;
        this._s.Ef();
        var e = new ir;
            ...
            return m(t, void 0, void 0, (function() {
                ...
                return g(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = ar(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
 ...
 */ function bu(t, e) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(o) {
            switch (o.label) {
              case 0:
                return t._s.Af(), T("FirestoreClient", "Initializing OfflineComponentProvider"), 
...
function Eu(t, e) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(i) {
            switch (i.label) {
              case 0:
                return t._s.Af(), [ 4 /*yield*/ , Iu(t) ];

              case 1:
                return n = i.sent(), T("FirestoreClient", "Initializing OnlineComponentProvider"), 
                [ 4 /*yield*/ , t.getConfiguration() ];
                        ...
                        return function(t, e) {
                            return m(this, void 0, void 0, (function() {
                                ...
                                return g(this, (function(i) {
                                    switch (i.label) {
                                      case 0:
                                        return (n = V(t))._s.Af(), T("RemoteStore", "RemoteStore received new credentials"), 
                                        r = yi(n), 
                                        // Tear down and re-create our network streams. This will ensure we get a
                                        // fresh auth token for the new user and re-fill the write pipeline with
                                        // new mutations from the LocalStore (since mutations are per-user).
                                        n.Nh.add(3 /* CredentialChange */), [ 4 /*yield*/ , ci(n) ];
                                      ...
                                      case 2:
                                        return i.sent(), n.Nh.delete(3 /* CredentialChange */), [ 4 /*yield*/ , ai(n) ];
...
function Iu(t) {
    return m(this, void 0, void 0, (function() {
        return g(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.mf ? [ 3 /*break*/ , 2 ] : (T("FirestoreClient", "Using default OfflineComponentProvider"), 
                [ 4 /*yield*/ , bu(t, new wo) ]);
...
function Tu(t) {
    return m(this, void 0, void 0, (function() {
        return g(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.If ? [ 3 /*break*/ , 2 ] : (T("FirestoreClient", "Using default OnlineComponentProvider"), 
                [ 4 /*yield*/ , Eu(t, new _o) ]);
    ...
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.gl).jh = Zi.bind(null, e._a), n.Hh = $i.bind(null, e._a), 
                n) ];
            }
        }));
    }));
                    ...
                    return r = function(t, e, n, r, i) {
                        var o = new Eo({
                            next: function(n) {
                                ...
                                e.Ps((function() {
                                    return Ui(t, u);
                                })), n.fromCache && "server" === r.source ? i.reject(new x(U.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
...
var Pu = /** @class */ function() {
    function t() {
        ...
        this.Gu = new ei(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.vf = function() {
            var e = $r();
            e && T("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.Gu.qu();
        };
        var e = $r();
    ...
    t.prototype.Cf = function() {
        ...
        var e = this, n = this.Rf.then((function() {
            return e.pf = !0, t().catch((function(t) {
                ...
                throw e.Vf = t, e.pf = !1, N("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
        ...
        var i = sr.Ts(this, t, e, n, (function(t) {
            return r.xf(t);
        }));
...
var Lu = /** @class */ function() {
    function t() {
        this.kf = {}, this.Mf = new ir, this.Lf = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
...
}(), Ru = -1, Uu = /** @class */ function(t) {
    /** @hideconstructor */
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, n) || this).Bf = new Pu, r.w_ = "name" in e ? e.name : "[DEFAULT]", 
        r;
    }
    return y(e, t), e.prototype.b_ = function() {
        return this.qf || 
        // The client must be initialized to ensure that all subsequent API
        // usage throws an exception.
        Mu(this), this.qf.terminate();
    }, e;
}(xo);
 ...
 * limitations under the License.
 */
/** DOMException error code constants. */ function xu(t) {
    return t.qf || Mu(t), t.qf.df(), t.qf;
}
...
var qu = /** @class */ function() {
    ...
    return t.prototype.Uf = function(t, e) {
        ...
        return new Qo(ot(t.latitude), ot(t.longitude));
        ...
        var n = X.ot(t);
        O(rr(n));
        var r = new b(n.get(1), n.get(3)), i = new J(n.Y(5));
        return r.isEqual(e) || 
        // TODO(b/64130202): Somehow support foreign references.
        N("Document " + i + " contains a document reference within a different database (" + r.projectId + "/" + r.database + ") which is not supported. It will be treated as a reference in the current database (" + e.projectId + "/" + e.database + ") instead."), 
        i;
    }, t;
}(), Fu = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "id", {
         ...
         */
        get: function() {
            return new Mo(this.Yf, this.v_, this.S_);
        },
        enumerable: !1,
        configurable: !0
    }), 
    ...
    t.prototype.data = function() {
        if (this.Zf) {
            if (this.v_) {
                ...
                var t = new ju(this.Yf, this.Xf, this.S_, this.Zf, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this.Zf) {
            var e = this.Zf.data().field(zu("DocumentSnapshot.get", t));
     ...
     */    return y(e, t), e.prototype.data = function() {
 ...
 */
function zu(t, e) {
    return "string" == typeof e ? vu(t, e) : e instanceof Ao ? e.d_.f_ : e.f_;
}
 ...
 * limitations under the License.
 */ function Gu(t) {
    if (ee(t) && 0 === t.xt.length) throw new x(U.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var Hu = /** @class */ function(t) {
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this) || this).ed = e, i.nd = n, i.sd = r, i.type = "where", 
        i;
    }
    return y(e, t), e.prototype.td = function(t) {
        var e = Jo(t.firestore), n = function(t, e, n, r, i, o, u) {
            var s;
            if (i.ut()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new x(U.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || $u(u, o), 
            s = au(n, "where", u, 
            /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
            var l = xt.create(i, o, s);
            return function(t, e) {
                if (e.Ct()) {
                    var n = re(t);
                    if (null !== n && !n.isEqual(e.field)) throw new x(U.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = ne(t);
                    null !== r && ts(t, e.field, r);
                }
                var i = function(t, e) {
                    for (var n = 0, r = t.filters; n < r.length; n++) {
                        var i = r[n];
 ...
 */
                ...
                throw i === e.op ? new x(U.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new x(U.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, l), l;
        }(t.C_, 0, e, t.firestore.I_, this.ed, this.nd, this.sd);
        return new qo(t.firestore, t.v_, function(t, e) {
            var n = t.filters.concat([ e ]);
            return new Jt(t.path, t.collectionGroup, t.xt.slice(), n, t.limit, t.limitType, t.startAt, t.endAt);
        }(t.C_, n));
    }, e;
    ...
    return y(e, t), e.prototype.td = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new x(U.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new x(U.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new Wt(e, n);
            return function(t, e) {
                if (null === ne(t)) {
                    // This is the first order by. It must match any inequality.
                    var n = re(t);
                    null !== n && ts(t, n, e.field);
                }
            }(t, r), r;
    ...
    return y(e, t), e.prototype.td = function(t) {
        return new qo(t.firestore, t.v_, se(t.C_, this.od, this.ad));
    }, e;
    ...
    return y(e, t), e.prototype.td = function(t) {
        var e = Zu(t, this.type, this.ud, this.hd);
        return new qo(t.firestore, t.v_, function(t, e) {
            return new Jt(t.path, t.collectionGroup, t.xt.slice(), t.filters.slice(), t.limit, t.limitType, e, t.endAt);
        }(t.C_, e));
    }, e;
}(Bu), Ku = /** @class */ function(t) {
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this) || this).type = e, i.ud = n, i.hd = r, i;
    }
    return y(e, t), e.prototype.td = function(t) {
        var e = Zu(t, this.type, this.ud, this.hd);
        return new qo(t.firestore, t.v_, function(t, e) {
            return new Jt(t.path, t.collectionGroup, t.xt.slice(), t.filters.slice(), t.limit, t.limitType, t.startAt, e);
        }(t.C_, e));
    }, e;
}(Bu);
...
function Zu(t, e, n, r) {
    if (n[0] instanceof Ao && (n[0] = n[0].d_), n[0] instanceof Fu) return function(t, e, n, r, i) {
        if (!r) throw new x(U.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        for (var o = [], u = 0, s = oe(t); u < s.length; u++) {
            var a = s[u];
            if (a.field.ut()) o.push(wt(e, r.key)); else {
                var c = r.field(a.field);
                if (st(c)) throw new x(U.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var f = a.field.rt();
                    throw new x(U.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + f + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    var i = Jo(t.firestore);
    return function(t, e, n, r, i, o) {
        // Use explicit order by's because it has to match the query the user made
        var u = t.xt;
        if (i.length > u.length) throw new x(U.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var s = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (u[a].field.ut()) {
                if ("string" != typeof c) throw new x(U.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!ie(t) && -1 !== c.indexOf("/")) throw new x(U.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var f = t.path.child(X.ot(c));
                if (!J.wt(f)) throw new x(U.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + f + "' is not because it contains an odd number of segments.");
                var h = new J(f);
                s.push(wt(e, h));
            } else {
                var l = au(n, r, c);
...
function Ju(t, e, n) {
    if (n instanceof Ao && (n = n.d_), "string" == typeof n) {
        if ("" === n) throw new x(U.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!ie(e) && -1 !== n.indexOf("/")) throw new x(U.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(X.ot(n));
        if (!J.wt(r)) throw new x(U.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return wt(t, new J(r));
    }
    if (n instanceof Mo) return wt(t, n.S_);
    throw new x(U.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Po(n) + ".");
}
 ...
 * array requirements.
 */ function $u(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new x(U.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new x(U.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function ts(t, e, n) {
    if (!n.isEqual(e)) throw new x(U.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
...
var ns = /** @class */ function(t) {
    function e(e) {
        var n = this;
        return (n = t.call(this) || this).firestore = e, n;
    }
    return y(e, t), e.prototype.Wf = function(t) {
        return new M(t);
    }, e.prototype.jf = function(t) {
        var e = this.Jf(t, this.firestore.I_);
        return new Mo(this.firestore, /* converter= */ null, e);
    }, e;
}(qu), rs = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
     ...
     */    return y(e, t), e.prototype.exists = function() {
    ...
    e.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this.Zf) {
            if (this.v_) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new os(this.Yf, this.Xf, this.S_, this.Zf, this.metadata, 
                /* converter= */ null);
    ...
    e.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this.Zf) {
            var n = this.Zf.data().field(zu("DocumentSnapshot.get", t));
            if (null !== n) return this.Xf.Uf(n, e.serverTimestamps);
        }
    }, e;
}(Fu), os = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    /**
     ...
     * have not yet been set to their final value).
     * @returns An `Object` containing all fields in the document.
     */    return y(e, t), e.prototype.data = function(e) {
        return void 0 === e && (e = {}), t.prototype.data.call(this, e);
    }, e;
}(is), us = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this.Yf = t, this.Xf = e, this._d = r, this.metadata = new rs(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._d.docs.forEach((function(r) {
            t.call(e, new os(n.Yf, n.Xf, r.key, r, new rs(n._d.De.has(r.key), n._d.fromCache), n.query.v_));
        }));
    }, 
    /**
    ...
    t.prototype.docChanges = function(t) {
        ...
        if (e && this._d.xe) throw new x(U.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t._d.Se.et()) {
                ...
                return t._d.docChanges.map((function(e) {
                    var r = new os(t.Yf, t.Xf, e.doc.key, e.doc, new rs(t._d.De.has(e.doc.key), t._d.fromCache), t.query.v_);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
            ...
            return t._d.docChanges.filter((function(t) {
                ...
                var n = new os(t.Yf, t.Xf, e.doc.key, e.doc, new rs(t._d.De.has(e.doc.key), t._d.fromCache), t.query.v_), i = -1, o = -1;
 ...
 */ function as(t, e) {
    return t instanceof is && e instanceof is ? t.Yf === e.Yf && t.S_.isEqual(e.S_) && (null === t.Zf ? null === e.Zf : t.Zf.isEqual(e.Zf)) && t.v_ === e.v_ : t instanceof us && e instanceof us && t.Yf === e.Yf && Bo(t.query, e.query) && t.metadata.isEqual(e.metadata) && t._d.isEqual(e._d);
}
 ...
 */ function fs(t, e, n) {
    ...
    t = Co(t, Mo);
    var o = Co(t.firestore, Uu), u = Jo(o);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    return e instanceof Ao && (e = e.d_), ls(o, [ ("string" == typeof e || e instanceof To ? su(u, "updateDoc", t.S_, e, n, r) : uu(u, "updateDoc", t.S_, e)).F_(t.S_, Pe.exists(!0)) ]);
}
 ...
 */ function hs(t) {
    ...
    t instanceof Ao && (t = t.d_);
    var u = {
        includeMetadataChanges: !1
    }, s = 0;
    "object" != typeof i[s] || Cu(i[s]) || (u = i[s], s++);
    var a, c, f, h = {
    ...
    if (t instanceof Mo) c = Co(t.firestore, Uu), f = $t(t.S_.path), a = {
        next: function(e) {
            i[s] && i[s](ps(c, t, e));
        },
        error: i[s + 1],
        ...
        var p = Co(t, qo);
        c = Co(p.firestore, Uu), f = p.C_;
        var d = new cs(c);
        a = {
            next: function(t) {
                i[s] && i[s](new us(c, d, p, t));
            },
            error: i[s + 1],
            complete: i[s + 2]
        }, Gu(t.C_);
    ...
    return function(t, e, n, r) {
        var i = this, o = new Eo(r), u = new Fi(e, o, n);
        return t._s.Ps((function() {
            return m(i, void 0, void 0, (function() {
                var e;
                return g(this, (function(n) {
...
/** Locally writes `mutations` on the async queue. */ function ls(t, e) {
    return function(t, e) {
        var n = this, r = new ir;
        return t._s.Ps((function() {
 ...
 */ function ps(t, e, n) {
    var r = n.docs.get(e.S_), i = new cs(t);
    return new is(t, i, e.S_, r, new rs(n.hasPendingWrites, n.fromCache), e.v_);
}
 ...
 */ var ds = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this.Yf = t, this.wd = e, this.Ed = [], this.Td = !1, this.Id = Jo(t);
    }
    return t.prototype.set = function(t, e, n) {
        this.md();
        var r = vs(t, this.Yf), i = es(r.v_, e, n), o = $o(this.Id, "WriteBatch.set", r.S_, i, null !== r.v_, n);
        return this.Ed.push(o.F_(r.S_, Pe.Kt())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this.md();
        var o, u = vs(t, this.Yf);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return e instanceof Ao && (e = e.d_), o = "string" == typeof e || e instanceof To ? su(this.Id, "WriteBatch.update", u.S_, e, n, r) : uu(this.Id, "WriteBatch.update", u.S_, e), 
        this.Ed.push(o.F_(u.S_, Pe.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this.md();
        var e = vs(t, this.Yf);
        return this.Ed = this.Ed.concat(new We(e.S_, Pe.Kt())), this;
    }, 
    /**
    ...
    t.prototype.commit = function() {
        ...
        if (this.Td) throw new x(U.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();

function vs(t, e) {
    if (t instanceof Ao && (t = t.d_), t.firestore !== e) throw new x(U.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ var ys = /** @class */ function(t) {
     ...
     */    return y(e, t), e.prototype.get = function(e) {
        var n = this, r = vs(e, this.Yf), i = new cs(this.Yf);
        return t.prototype.get.call(this, e).then((function(t) {
            return new is(n.Yf, i, r.S_, t.Zf, new rs(
            /* hasPendingWrites= */ !1, 
            /* fromCache= */ !1), r.v_);
        }));
    }, e;
    ...
    /** @hideconstructor */
    function t(t, e) {
        this.Yf = t, this.Ad = e, this.Id = Jo(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = vs(t, this.Yf), r = new ns(this.Yf);
        return this.Ad.ef([ n.S_ ]).then((function(t) {
            if (!t || 1 !== t.length) return S();
            var i = t[0];
            if (i instanceof Vt) return new Fu(e.Yf, r, n.S_, null, n.v_);
            if (i instanceof Ot) return new Fu(e.Yf, r, i.key, i, n.v_);
            throw S();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = vs(t, this.Yf), i = es(r.v_, e, n), o = $o(this.Id, "Transaction.set", r.S_, i, null !== r.v_, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return e instanceof Ao && (e = e.d_), o = "string" == typeof e || e instanceof To ? su(this.Id, "Transaction.update", u.S_, e, n, r) : uu(this.Id, "Transaction.update", u.S_, e), 
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function ms() {
    if ("undefined" == typeof Uint8Array) throw new x(U.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function gs() {
    if ("undefined" == typeof atob) throw new x(U.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}

/** Immutable class holding a blob (binary data) */ var ws = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return y(e, t), e.fromBase64String = function(t) {
        return gs(), new e(M.fromBase64String(t));
    }, e.fromUint8Array = function(t) {
        return ms(), new e(M.fromUint8Array(t));
    }, e.prototype.toBase64 = function() {
        return gs(), this.d_.toBase64();
    }, e.prototype.toUint8Array = function() {
        return ms(), this.d_.toUint8Array();
    }, e.prototype.isEqual = function(t) {
        return this.d_.isEqual(t.d_);
    }, e.prototype.toString = function() {
        return "Blob(base64: " + this.toBase64() + ")";
    }, e;
}(Ao), _s = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", bs = /** @class */ function() {
    function t() {}
    return t.prototype.enableIndexedDbPersistence = function(t, e) {
        throw new x(U.FAILED_PRECONDITION, _s);
    ...
    function e(e, n, r) {
        ...
        }, e instanceof b || (i.Pd = e), i;
    }
    return y(e, t), Object.defineProperty(e.prototype, "I_", {
        get: function() {
            return this.d_.I_;
        },
        enumerable: !1,
        ...
        !function(t, e, n) {
            var r = (t = Co(t, xo)).V_();
            "firestore.googleapis.com" !== r.host && r.host !== e && A("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
                ...
                return m(e, void 0, void 0, (function() {
                    ...
                    return g(this, (function(r) {
                        switch (r.label) {
                          ...
                          case 1:
                            return e = r.sent(), [ 4 /*yield*/ , Du(t) ];

                          case 2:
                            return n = r.sent(), [ 2 /*return*/ , (e.yo(!0), function(t) {
                                var e = V(t);
                                return e.Nh.delete(0 /* UserDisabled */), ai(e);
                            }(n)) ];
                        }
                    }));
                }));
        ...
        /** Disables the network connection. Pending operations will not complete. */ (xu(Co(this.d_, Uu)));
                            ...
                            return n = r.sent(), [ 2 /*return*/ , (e.yo(!1), function(t) {
                                return m(this, void 0, void 0, (function() {
                                    ...
                                    return g(this, (function(n) {
                                        switch (n.label) {
                                          case 0:
                                            return (e = V(t)).Nh.add(0 /* UserDisabled */), [ 4 /*yield*/ , ci(e) ];
 ...
 */ (xu(Co(this.d_, Uu)));
        ...
        var e = !1, n = !1;
        return t && Oo("synchronizeTabs", e = !!t.synchronizeTabs, "experimentalForceOwningTab", n = !!t.experimentalForceOwningTab), 
 ...
 */;
        ...
        get: function() {
            if (!this.Pd) throw new x(U.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Pd;
        },
        enumerable: !1,
        configurable: !0
        ...
        try {
            return new xs(this, jo(this.d_, t));
        } catch (t) {
            throw Os(t, "collection()", "Firestore.collection()");
        }
    }, e.prototype.doc = function(t) {
        try {
            return new Ss(this, zo(this.d_, t));
        } catch (t) {
            throw Os(t, "doc()", "Firestore.doc()");
        }
    }, e.prototype.collectionGroup = function(t) {
        try {
            return new Ls(this, function(t, e) {
                if (t = Co(t, xo), Do("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new x(U.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new qo(t, 
                /* converter= */ null, 
                /**
 ...
 */
                function(t) {
                    return new Jt(X.ct(), t);
                }(e));
            }(this.d_, t));
        } catch (t) {
            throw Os(t, "collectionGroup()", "Firestore.collectionGroup()");
        }
                    ...
                    return m(n, void 0, void 0, (function() {
                        ...
                        return g(this, (function(i) {
                            switch (i.label) {
                              ...
                              case 1:
                                return n = i.sent(), new wu(t._s, n, e, r).run(), [ 2 /*return*/ ];
                            }
                        }));
                    }));
                })), r.promise;
        ...
        var t = this;
        return xu(this.d_), new As(new ds(this.d_, (function(e) {
            return ls(t.d_, e);
        })));
    }, e.prototype.loadBundle = function(t) {
        throw new x(U.FAILED_PRECONDITION, '"loadBundle()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, e.prototype.namedQuery = function(t) {
        throw new x(U.FAILED_PRECONDITION, '"namedQuery()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, e;
}(Ao), Is = /** @class */ function(t) {
    function e(e) {
        var n = this;
        return (n = t.call(this) || this).firestore = e, n;
    }
    return y(e, t), e.prototype.Wf = function(t) {
        return new ws(new M(t));
    }, e.prototype.jf = function(t) {
        var e = this.Jf(t, this.firestore.I_);
        return Ss.yd(e, this.firestore, /* converter= */ null);
    }, e;
}(qu);
 ...
 */ var Ns = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, n) || this).Yf = e, r.Xf = new Is(e), r;
    }
    return y(e, t), e.prototype.get = function(t) {
        var e = this, n = Ms(t);
        return this.d_.get(n).then((function(t) {
            return new Ps(e.Yf, new is(e.Yf.d_, e.Xf, t.S_, t.Zf, t.metadata, n.v_));
        }));
    }, e.prototype.set = function(t, e, n) {
        var r = Ms(t);
        return n ? (So("Transaction.set", n), this.d_.set(r, e, n)) : this.d_.set(r, e), 
        this;
    }, e.prototype.update = function(t, e, n) {
        for (var r, i = [], o = 3; o < arguments.length; o++) i[o - 3] = arguments[o];
        var u = Ms(t);
        return 2 === arguments.length ? this.d_.update(u, e) : (r = this.d_).update.apply(r, w([ u, e, n ], i)), 
        this;
    }, e.prototype.delete = function(t) {
        var e = Ms(t);
        return this.d_.delete(e), this;
    }, e;
}(Ao), As = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return y(e, t), e.prototype.set = function(t, e, n) {
        var r = Ms(t);
        return n ? (So("WriteBatch.set", n), this.d_.set(r, e, n)) : this.d_.set(r, e), 
        this;
    }, e.prototype.update = function(t, e, n) {
        for (var r, i = [], o = 3; o < arguments.length; o++) i[o - 3] = arguments[o];
        var u = Ms(t);
...
}(Ao), Ds = /** @class */ function(t) {
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this, r) || this).Yf = e, i.Xf = n, i;
    }
    return y(e, t), e.prototype.fromFirestore = function(t, e) {
        var n = new os(this.Yf.d_, this.Xf, t.S_, t.Zf, t.metadata, 
        /* converter= */ null);
        return this.d_.fromFirestore(new Cs(this.Yf, n), null != e ? e : {});
    ...
    e.gd = function(t, n) {
        ...
        var o = i.get(n);
        return o || (o = new e(t, new Is(t), n), i.set(n, o)), o;
    }, e;
}(Ao);
...
var Ss = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, n) || this).firestore = e, r.Xf = new Is(e), r;
    }
    return y(e, t), e.pd = function(t, n, r) {
        if (t.length % 2 != 0) throw new x(U.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.rt() + " has " + t.length);
        return new e(n, new Mo(n.d_, r, new J(t)));
    }, e.yd = function(t, n, r) {
        return new e(n, new Mo(n.d_, r, t));
        ...
        get: function() {
            return new xs(this.firestore, this.d_.parent);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(e.prototype, "path", {
        ...
        try {
            return new xs(this.firestore, jo(this.d_, t));
        } catch (t) {
            throw Os(t, "collection()", "DocumentReference.collection()");
        }
    }, e.prototype.isEqual = function(t) {
        return t instanceof Ao && (t = t.d_), t instanceof Mo && Go(this.d_, t);
    }, e.prototype.set = function(t, e) {
        e = So("DocumentReference.set", e);
        try {
            return function(t, e, n) {
                t = Co(t, Mo);
                var r = Co(t.firestore, Uu), i = es(t.v_, e, n);
                return ls(r, [ $o(Jo(r), "setDoc", t.S_, i, null !== t.v_, n).F_(t.S_, Pe.Kt()) ]);
            }(this.d_, t, e);
        } catch (t) {
            throw Os(t, "setDoc()", "DocumentReference.set()");
        }
    }, e.prototype.update = function(t, e) {
        for (var n = [], r = 2; r < arguments.length; r++) n[r - 2] = arguments[r];
        try {
            return 1 === arguments.length ? fs(this.d_, t) : fs.apply(void 0, w([ this.d_, t, e ], n));
        } catch (t) {
            throw Os(t, "updateDoc()", "DocumentReference.update()");
        }
    }, e.prototype.delete = function() {
        return ls(Co((t = this.d_).firestore, Uu), [ new We(t.S_, Pe.Kt()) ]);
        var t;
        /**
 ...
 */    }, e.prototype.onSnapshot = function() {
        ...
        var r = Vs(e), i = ks(e, (function(e) {
            return new Ps(t.firestore, new is(t.firestore.d_, t.Xf, e.S_, e.Zf, e.metadata, t.d_.v_));
        }));
        return hs(this.d_, r, i);
    }, e.prototype.get = function(t) {
        var e = this;
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            t = Co(t, Mo);
            var e = Co(t.firestore, Uu), n = xu(e), r = new cs(e);
            return function(t, e) {
                var n = this, r = new ir;
                return t._s.Ps((function() {
                    return m(n, void 0, void 0, (function() {
                                    ...
                                    return m(this, void 0, void 0, (function() {
                                        ...
                                        return g(this, (function(o) {
                                            switch (o.label) {
                                              ...
                                              case 1:
                                                return (i = o.sent()) instanceof Ot ? n.resolve(i) : i instanceof Vt ? n.resolve(null) : n.reject(new x(U.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                [ 3 /*break*/ , 3 ];

                                              case 2:
                                                return r = o.sent(), i = ar(r, "Failed to get document '" + e + " from cache"), 
                ...
                return new is(e, r, t.S_, n, new rs(n instanceof Ot && n.Vt, 
                /* fromCache= */ !0), t.v_);
            }));
        }(this.d_) : "server" === (null == t ? void 0 : t.source) ? function(t) {
            t = Co(t, Mo);
            var e = Co(t.firestore, Uu);
            return Vu(xu(e), t.S_, {
                source: "server"
            }).then((function(n) {
                return ps(e, t, n);
            ...
            t = Co(t, Mo);
            var e = Co(t.firestore, Uu);
            return Vu(xu(e), t.S_).then((function(n) {
                return ps(e, t, n);
            }));
        }(this.d_)).then((function(t) {
            return new Ps(e.firestore, new is(e.firestore.d_, e.Xf, t.S_, t.Zf, t.metadata, e.d_.v_));
        }));
    }, e.prototype.withConverter = function(t) {
        return new e(this.firestore, this.d_.withConverter(Ds.gd(this.firestore, t)));
    }, e;
}(Ao);
...
function Vs(t) {
    for (var e = 0, n = t; e < n.length; e++) {
        var r = n[e];
        if ("object" == typeof r && !Cu(r)) return r;
    }
    return {};
}
 ...
 */ function ks(t, e) {
    ...
    return {
        ...
        error: null === (n = (i = Cu(t[0]) ? t[0] : Cu(t[1]) ? t[1] : "function" == typeof t[0] ? {
            next: t[0],
            error: t[1],
            complete: t[2]
        } : {
...
var Ps = /** @class */ function(t) {
    ...
    return y(e, t), Object.defineProperty(e.prototype, "ref", {
        get: function() {
            return new Ss(this.Yf, this.d_.ref);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(e.prototype, "id", {
        ...
        return as(this.d_, t.d_);
    }, e;
}(Ao), Cs = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return y(e, t), e.prototype.data = function(t) {
        return this.d_.data(t);
    }, e;
}(Ps), Ls = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, n) || this).firestore = e, r.Xf = new Is(e), r;
    }
    return y(e, t), e.prototype.where = function(t, n, r) {
        try {
            // The "as string" cast is a little bit of a hack. `where` accepts the
            // FieldPath Compat type as input, but is not typed as such in order to
            // not expose this via our public typings file.
            return new e(this.firestore, Qu(this.d_, function(t, e, n) {
                var r = e, i = zu("where", t);
                return new Hu(i, r, n);
            }(t, n, r)));
        } catch (t) {
            throw Os(t, /(orderBy|where)\(\)/, "Query.$1()");
        }
        ...
        try {
            ...
            // FieldPath Compat type as input, but is not typed as such in order to
            // not expose this via our public typings file.
            return new e(this.firestore, Qu(this.d_, function(t, e) {
                void 0 === e && (e = "asc");
                var n = e, r = zu("orderBy", t);
                return new Yu(r, n);
            }(t, n)));
        } catch (t) {
            throw Os(t, /(orderBy|where)\(\)/, "Query.$1()");
        ...
        try {
            return new e(this.firestore, Qu(this.d_, function(t) {
                return Lo("limit", t), new Wu("limit", t, "F" /* First */);
            }(t)));
        } catch (t) {
            throw Os(t, "limit()", "Query.limit()");
        }
    }, e.prototype.limitToLast = function(t) {
        try {
            return new e(this.firestore, Qu(this.d_, function(t) {
                return Lo("limitToLast", t), new Wu("limitToLast", t, "L" /* Last */);
            }(t)));
        } catch (t) {
            throw Os(t, "limitToLast()", "Query.limitToLast()");
        }
    }, e.prototype.startAt = function() {
        for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
        try {
            return new e(this.firestore, Qu(this.d_, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new Xu("startAt", t, /*before=*/ !0);
            }.apply(void 0, t)));
        } catch (t) {
            throw Os(t, "startAt()", "Query.startAt()");
        }
        ...
        try {
            return new e(this.firestore, Qu(this.d_, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new Xu("startAfter", t, 
                /*before=*/ !1);
            }.apply(void 0, t)));
        } catch (t) {
            throw Os(t, "startAfter()", "Query.startAfter()");
        }
        ...
        try {
            ...
            throw Os(t, "endBefore()", "Query.endBefore()");
        }
        ...
        try {
            ...
            throw Os(t, "endAt()", "Query.endAt()");
        }
    }, e.prototype.isEqual = function(t) {
        return Bo(this.d_, t.d_);
    }, e.prototype.get = function(t) {
        var e = this;
     ...
     */
        function(t) {
                                ...
                                return n = function(t, e, n) {
                                    return m(this, void 0, void 0, (function() {
                                        ...
                                        return g(this, (function(a) {
                                            switch (a.label) {
                                              case 0:
                                                return a.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , Cr(t, e, 
                                                /* usePreviousResults= */ !0) ];

                                              case 1:
                                                return s = a.sent(), r = new Yi(e, s.Rc), i = r.fl(s.documents), o = r.wi(i, 
                                                /* updateLimboDocuments= */ !1), n.resolve(o.snapshot), [ 3 /*break*/ , 3 ];

                                              case 2:
                                                return u = a.sent(), s = ar(u, "Failed to execute query '" + e + " against cache"), 
            ...
            t = Co(t, qo);
            var e = Co(t.firestore, Uu), n = xu(e), r = new cs(e);
            return Gu(t.C_), ku(n, t.C_).then((function(n) {
                return new us(e, r, t, n);
            }));
        }(this.d_)).then((function(t) {
            return new Us(e.firestore, new us(e.firestore.d_, e.Xf, e.d_, t._d));
        }));
    }, e.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = Vs(e), i = ks(e, (function(e) {
            return new Us(t.firestore, new us(t.firestore.d_, t.Xf, t.d_, e._d));
        }));
        return hs(this.d_, r, i);
    }, e.prototype.withConverter = function(t) {
        return new e(this.firestore, this.d_.withConverter(Ds.gd(this.firestore, t)));
    }, e;
}(Ao), Rs = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, n) || this).Yf = e, r;
    }
    return y(e, t), Object.defineProperty(e.prototype, "type", {
        get: function() {
            return this.d_.type;
        },
        enumerable: !1,
        ...
        get: function() {
            return new Cs(this.Yf, this.d_.doc);
        },
        enumerable: !1,
        configurable: !0
...
}(Ao), Us = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, n) || this).Yf = e, r;
    }
    return y(e, t), Object.defineProperty(e.prototype, "query", {
        get: function() {
            return new Ls(this.Yf, this.d_.query);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(e.prototype, "metadata", {
        ...
        return this.d_.docChanges(t).map((function(t) {
            return new Rs(e.Yf, t);
        }));
    }, e.prototype.forEach = function(t, e) {
        var n = this;
        this.d_.forEach((function(r) {
            t.call(e, new Cs(n.Yf, r));
        }));
    }, e.prototype.isEqual = function(t) {
        return as(this.d_, t.d_);
    }, e;
}(Ao), xs = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
    ...
    return y(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        try {
            return new Ss(this.firestore, void 0 === t ? zo(this.d_) : zo(this.d_, t));
        } catch (t) {
            throw Os(t, "doc()", "CollectionReference.doc()");
        }
    }, e.prototype.add = function(t) {
        var e = this;
        return function(t, e) {
            var n = Co(t.firestore, Uu), r = zo(t), i = es(t.v_, e);
            return ls(n, [ $o(Jo(t.firestore), "addDoc", r.S_, i, null !== t.v_, {}).F_(r.S_, Pe.exists(!1)) ]).then((function() {
                return r;
            }));
...
function Ms(t) {
    return t instanceof Ao && (t = t.d_), Co(t, Mo);
}
 ...
 */ var qs = /** @class */ function(t) {
    ...
    function e() {
        ...
        return t.call(this, new (To.bind.apply(To, w([ void 0 ], e)))) || this;
    }
    return y(e, t), e.documentId = function() {
        /**
         ...
         * effect is the same.
         */
        return new e(Z.ht().rt());
    }, e.prototype.isEqual = function(t) {
        return t instanceof Ao && (t = t.d_), t instanceof To && this.d_.f_.isEqual(t.f_);
    }, e;
}(Ao), Fs = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return y(e, t), e.serverTimestamp = function() {
        var t = new nu("serverTimestamp");
        return t._methodName = "FieldValue.serverTimestamp", new e(t);
    }, e.delete = function() {
        var t = new tu("deleteField");
 ...
 */
    return function(t, e) {
        var n = xu(t = Co(t, Uu)), r = new Lu;
        return function(t, e, n, r) {
            var i = this, o = function(t, e) {
                return function(t, e) {
                    return new Io(t, e);
                }(function(t, e) {
                    if (t instanceof Uint8Array) return bo(t, e);
                    if (t instanceof ArrayBuffer) return bo(new Uint8Array(t), e);
...
function zs(t) {
    ...
    }(xu(e = Co(e, Uu)), n).then((function(t) {
        return t ? new qo(e, null, t.query) : null;
    }))).then((function(t) {
        return t ? new Ls(r, t) : null;
    }));
}

export { As as G, Ss as H, H as K, ws as L, Es as Q, Ts as W, Uu as X, Ru as Y, Qo as Z, Ps as a, js as b, Fs as c, Ls as e, xs as i, Ns as j, qs as o, bs as q, Us as s, Cs as t, zs as u };
//# sourceMappingURL=prebuilt-70072921-2a8dc8e3.js.map
