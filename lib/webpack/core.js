...
module.exports = (env, requestedEngines) => {
    ...
    var config = {
        ...
        entry: {
            "lesli/templates/public": "LesliStyle/templates/public.scss",
            "lesli/templates/application": "LesliStyle/templates/application.scss",
            "lesli/users/sessions": ["LesliVue/devise/sessions.js", "LesliStyle/devise/sessions.scss"]
        },
        output: {
