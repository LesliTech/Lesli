...
class UsersController < ApplicationLesliController
    ...
    def options
        ...
        respond_with_successful({
            ...
            locales: Rails.application.config.lesli["configuration"]["locales_available"]
        })
    ...
    def become
        ...
        return respond_with_unauthorized if current_user.email != Rails.application.config.lesli["account"]["user"]["email"] # sysadmin user
