...
@description App that retrieves and shows, and allows the user to edit/update a
    Settings specified by the id in the route.
...
export default {
    ...
    methods: {
        ...
        getSettings(){
            this.http.get(`${this.main_route}/${this.settings_id}.json`).then(result => {
...
<template>
    <section class="section">
        <component-form v-if="settings" :settings="settings" view-type="edit"/>
    </section>
</template>
