...
;// CONCATENATED MODULE: ../../app/vue2/users/registrations.js
/*
...
vue_public({
  ...
  methods: {
    postRegistration: function postRegistration(event) {
      var _this = this;
      ...
      this.http.post(this.url.to(), data).then(function (response) {
        ...
        _this.showNotification("We sent an confirmation email, please confirm your email address", 'is-success');
