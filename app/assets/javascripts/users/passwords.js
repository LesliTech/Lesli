...
/* harmony default export */ const vue_public = (function (app) {
  ...
  functions_document.ready(function () {
    ...
    if (true) {
      ...
      debug_browser_default().info("[BUILD] (core) 220529.1729 ");
    }
  });
});
...
;// CONCATENATED MODULE: ../../app/vue2/users/passwords.js
/*
Copyright (c) 2020, all rights reserved.
...
vue_public({
  ...
  methods: {
    postPasswordNew: function postPasswordNew(event) {
      var _this = this;
      ...
      this.http.post("/password", data).then(function (response) {
        console.log(response);
        _this.progress_bar_active = false;

        if (response.successful) {
          _this.showNotification(_this.translations.main.notification_reset_password_instructions_sent, "has-text-success");
        } else {
          _this.showNotification(response.error.message, "has-text-danger");
        }
      }).catch(function (error) {
        console.log(error);
      });
    },
    putPasswordEdit: function putPasswordEdit(event) {
      var _this2 = this;

      event.preventDefault(); // check if passwords match
      ...
      this.http.put("/password", {
        ...
        _this2.progress_bar_active = false;

        if (response.successful) {
          _this2.showNotification(_this2.translations.main.notification_password_updated, "success");
