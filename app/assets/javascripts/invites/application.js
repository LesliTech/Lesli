...
;// CONCATENATED MODULE: ../../app/vue2/invites/app.js
/*
Copyright (c) 2020, all rights reserved.
...
vue_public({
  ...
  methods: {
    postInvite: function postInvite(event) {
      var _this = this;
      ...
      this.http.post("/invite.json", {
        ...
        _this.showNotification("Invitation request sent", "is-success");
      }).catch(function (error) {
        console.log(error);
      }).finally(function () {
        _this.invite.email = "";
        _this.invite.telephone = "";
        _this.invite.full_name = "";
        _this.invite.note = "";
      });
    },
