...
var TimeCol = /** @class */ (function (_super) {
    ...
    TimeCol.prototype.renderPrintFgSegs = function (segs) {
        ...
        return segs.map(function (seg) { return (common.createElement("div", { className: "fc-timegrid-event-harness", key: seg.eventRange.instance.instanceId },
            common.createElement(TimeColEvent, tslib.__assign({ seg: seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: false, isCondensed: false }, common.getSegMeta(seg, props.todayRange, props.nowDate))))); });
    };
