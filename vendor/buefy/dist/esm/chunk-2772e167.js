...
var script$1 = {
  name: 'BPagination',
  components: (_components = {}, _defineProperty(_components, Icon.name, Icon), _defineProperty(_components, __vue_component__.name, __vue_component__), _components),
  props: {
    total: [Number, String],
    perPage: {
      type: [Number, String],
...
export { __vue_component__$1 as P, __vue_component__ as a };
