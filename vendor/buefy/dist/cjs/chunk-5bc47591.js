...
var script = {
  ...
  computed: {
    newType: function newType() {
      return this.type || __chunk_2.config.defaultTooltipType;
    },
    newAnimated: function newAnimated() {
      return this.animated || __chunk_2.config.defaultTooltipAnimated;
    },
    newDelay: function newDelay() {
      return this.delay || __chunk_2.config.defaultTooltipDelay;
    }
  }
};
...
exports.Tooltip = __vue_component__;
