...
var script$1 = {
  name: 'BPagination',
  components: (_components = {}, __chunk_1._defineProperty(_components, __chunk_4.Icon.name, __chunk_4.Icon), __chunk_1._defineProperty(_components, __vue_component__.name, __vue_component__), _components),
  props: {
    total: [Number, String],
    perPage: {
      type: [Number, String],
...
exports.Pagination = __vue_component__$1;
exports.PaginationButton = __vue_component__;
