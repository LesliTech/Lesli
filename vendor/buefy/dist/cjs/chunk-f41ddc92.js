...
var __vue_staticRenderFns__ = [];
  ...
  var PaginationButton = __chunk_6.__vue_normalize__(
...
var script$1 = {
  name: 'BPagination',
  components: (_components = {}, __chunk_1._defineProperty(_components, __chunk_5.Icon.name, __chunk_5.Icon), __chunk_1._defineProperty(_components, PaginationButton.name, PaginationButton), _components),
  props: {
    total: [Number, String],
    perPage: {
      type: [Number, String],
