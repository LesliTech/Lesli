...
ActiveRecord::Schema.define(version: 2020_05_26_180220) do
  ...
  create_table "roles_privilege_defaults", force: :cascade do |t|
    t.string "grant_object"
    t.boolean "grant_index", default: false
    t.boolean "grant_edit", default: false
    t.boolean "grant_show", default: false
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "role_privileges_id"
    t.index ["deleted_at"], name: "index_roles_privilege_defaults_on_deleted_at"
    t.index ["role_privileges_id"], name: "index_roles_privilege_defaults_on_role_privileges_id"
  end
  ...
  add_foreign_key "roles_privilege_defaults", "role_privileges", column: "role_privileges_id"
