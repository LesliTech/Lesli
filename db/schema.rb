...
ActiveRecord::Schema.define(version: 10010104) do
  ...
  create_table "cloud_house_projects", force: :cascade do |t|
    ...
    t.index ["cloud_house_workflow_details_id"], name: "house_projects_workflow_details"
  ...
  create_table "cloud_house_property_binding_validations", force: :cascade do |t|
    ...
    t.float "montly_pension_value"
    t.float "free_rent_value"
    t.float "yearly_value"
    t.float "property_factor_value"
  ...
  add_foreign_key "cloud_house_projects", "cloud_house_workflow_details", column: "cloud_house_workflow_details_id"
  ...
  add_foreign_key "cloud_lock_users", "users", column: "login_id"
