...
RSpec.describe "GET:/administration/profile/webpushes.json", type: :request, :unless => defined?(DeutscheLeibrenten) do
    describe "GET:/administration/profile/webpushes.json", type: :request do
        ...
        it "is expected to respond a hash not empty whit diferent key value" do
            get("/administration/profile/webpushes.json", params: @params)
