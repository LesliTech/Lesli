...
RSpec.describe "GET:/administration/account/locations", type: :request do 
    ...
    it "is expected to return with a list of locations created" do
        ...
        expect(@response_body_data.last["accounts_id"]).to eql(@location[:accounts_id])
    end
