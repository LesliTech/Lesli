  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Dashboard" do
        expect {
          post :create, params: {dashboard: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {dashboard: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested dashboard" do
        dashboard = Dashboard.create! valid_attributes
        put :update, params: {id: dashboard.to_param, dashboard: new_attributes}, session: valid_session
        dashboard.reload
      ...
      it "redirects to the dashboard" do
        dashboard = Dashboard.create! valid_attributes
        put :update, params: {id: dashboard.to_param, dashboard: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        dashboard = Dashboard.create! valid_attributes
        put :update, params: {id: dashboard.to_param, dashboard: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
